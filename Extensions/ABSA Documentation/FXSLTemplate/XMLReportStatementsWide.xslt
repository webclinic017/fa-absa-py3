    ...
    <xsl:template match="/XMLReport">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                ...
                <fo:page-sequence-master master-name="VAL_STATEMENTS_WIDE">
                ...
                <fo:simple-page-master master-name="first_only" margin-top="10mm" margin-bottom="10mm" margin-left="15mm" margin-right="15mm">
                ...
                <fo:simple-page-master master-name="other_pages" margin-top="20mm" margin-bottom="10mm" margin-left="15mm" margin-right="15mm">
                    <xsl:attribute name="page-width">
                        <xsl:value-of select="$width" />
                    </xsl:attribute>
                    <xsl:attribute name="page-height">
            ...
            <fo:page-sequence master-reference="VAL_STATEMENTS_WIDE">
                ...
                <fo:flow flow-name="xsl-region-body" font-size="8pt">
                    ...
                    <fo:table table-layout="fixed" width="100%">
                        <xsl:choose>
                            <xsl:when test="$isLandscape">
                                <fo:table-column column-width="133.5mm" />
                                <fo:table-column column-width="133.5mm" />
                            </xsl:when>
                            <xsl:otherwise>
