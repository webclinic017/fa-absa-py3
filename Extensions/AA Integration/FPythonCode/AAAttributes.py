...
ATTRIBUTES = {
    ...
    'START_MEMORY_CUBE_SERVICE': True,
...
FRTBATTRIBUTES['START_MEMORY_CUBE_SERVICE'] = True
...
SACCRATTRIBUTES['START_MEMORY_CUBE_SERVICE'] = True
SACCRATTRIBUTES['ARTIQ_DESTINATION_SNAPSHOT'] = SACCR_SNAPSHOT

CSVFILEIMPORTATTRIBUTES = ATTRIBUTES.copy()
CSVFILEIMPORTATTRIBUTES['START_MEMORY_CUBE_SERVICE'] = True
...
KVAATTRIBUTES['START_MEMORY_CUBE_SERVICE'] = True
