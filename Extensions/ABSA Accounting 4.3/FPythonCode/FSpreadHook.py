...
# FABIANPE: Front Upgrade 2013.3 -- the following imports are not used anywhere 
# and have been removed in 2013
#from FBDPCommon import eps_compare, FCalculatedPrice
#from FBDPSingleton import FBatchTransaction
...
def rerate_spread(ins, wrapper):
    ...
    resets=l.resets()
    for r in resets:
        if r.end_day>=date and r.start_day<=date:
            spread=r.value
            pass
    return spread
...
class CalculateSpread:
    ...
    def readfile( self ):
        try:
            ...
            print 'I/O error: Failed to open output file: ' + self.filename 
        except:
