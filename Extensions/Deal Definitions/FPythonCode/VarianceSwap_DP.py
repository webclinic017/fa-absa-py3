...
class VarianceSwapDefinition(DealDefinition):
    ...
    def InstrumentPanes(self):
        return 'CustomPanes_VarianceSwap'
        
    def TradePanes(self):
        return 'CustomPanes_VarianceSwapTrade'
