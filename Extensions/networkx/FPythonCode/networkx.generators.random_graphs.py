...
def fast_gnp_random_graph(n, p, seed=None, directed=False):
    """Returns a $G_{n,p}$ random graph, also known as an Erdos-Rényi graph or
    a binomial graph.
...
def gnp_random_graph(n, p, seed=None, directed=False):
    """Returns a $G_{n,p}$ random graph, also known as an Erdos-Rényi graph
    or a binomial graph.
    ...
    References
    ----------
    .. [1] P. Erdos and A. Rényi, On Random Graphs, Publ. Math. 6, 290 (1959).
...
def random_kernel_graph(n, kernel_integral, kernel_root=None, seed=None):
    ...
    Examples
    --------
    Generate an Erdos–Rényi random graph $G(n,c/n)$, with kernel
