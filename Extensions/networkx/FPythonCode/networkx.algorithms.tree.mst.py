...
def boruvka_mst_edges(G, minimum=True, weight='weight',
    ...
    """Iterate over edges of a Boruvka's algorithm min/max spanning tree.
...
def minimum_spanning_edges(G, algorithm='kruskal', weight='weight',
    ...
    Notes
    -----
    For Boruvka's algorithm, each edge must have a weight attribute, and
