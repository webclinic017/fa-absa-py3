...
#__src_file__ = "extensions/SecuritiesLending/etc/FSheetFilterApplication.py"
from __future__ import print_function
"""------------------------------------------------------------------------------------------------------
MODULE
    FSheetFilterApplication
...
def CreateApplicationInstance():
    return SheetFilterApplication()

def StartFilterApplicationModal(content):
    acm.StartApplication('Sheet Filter', content)
...
class FilterApplicationMenuItem(FUxCore.MenuItem):
    ...
    def Invoke(self, cd):
        try:
            ...
            print("FilterApplicationMenuItem Invoke error:", traceback.format_exc())
...
class SheetFilterApplication(FUxCore.LayoutApplication):
    ...
    def StoredColumns(self):
        columns = FSheetUtils.ColumnIds('SheetFilterDefaultColumns2', 'FPortfolioSheet')
        if columns:
    ...
    def HandleStandardFileCommandInvoke(self, commandName):
        try:
            ...
            print("HandleStandardFileCommandInvoke", traceback.format_exc())
