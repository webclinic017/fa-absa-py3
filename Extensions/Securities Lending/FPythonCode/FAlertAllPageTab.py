...
#__src_file__ = "extensions/SecuritiesLending/etc/FAlertAllPageTab.py"
import acm, ael
import FSheetUtils
...
class AlertAllPage(AlertPage):
    
    _SETTINGS = ParameterSettingsCreator.FromRootParameter('AlertAllPage')
