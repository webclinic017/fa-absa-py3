...
#__src_file__ = "extensions/arc_writers/./etc/FMarketRiskAddContentTab.py"
"""----------------------------------------------------------------------------
MODULE
    FMarketRiskAddContentTab - Add content to the report
...
class MarketRiskAddContentTab(FRunScriptGUI.AelVariablesHandler):
...
def getAelVariables():
    ...
    ael_vars = MarketRiskAddContentTab()
