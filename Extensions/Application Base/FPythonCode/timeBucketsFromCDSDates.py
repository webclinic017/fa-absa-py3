...
def ael_custom_dialog_show(shell, params):
    ...
    return TimeBucketHelperFunctions.ShowCreateBucketsFromCDSOrIMMDialog(shell, params, 'CDS Adjusted Buckets')
...
def CreateBuckets( parameters ):
    ...
    return TimeBucketHelperFunctions.CreateIMMOrCDSTimeBucketDefinitions(startDate, numberOfBucketInput, 'CDS Convention')
