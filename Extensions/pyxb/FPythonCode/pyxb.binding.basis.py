...
class _TypeBinding_mixin (utility.Locatable_mixin):
    ...
    _ReservedSymbols = { 'validateBinding', 'toDOM', 'toxml', 'Factory', 'property' }
...
class simpleTypeDefinition (_TypeBinding_mixin, utility._DeconflictSymbols_mixin, _DynamicCreate_mixin):
    ...
    _ReservedSymbols = _TypeBinding_mixin._ReservedSymbols.union({ 'XsdLiteral', 'xsdLiteral',
...
class enumeration_mixin (pyxb.cscRoot):
    ...
    _ReservedSymbols = { 'itervalues', 'values', 'iteritems', 'items' }
...
class complexTypeDefinition (_TypeBinding_mixin, utility._DeconflictSymbols_mixin, _DynamicCreate_mixin):
    ...
    _ReservedSymbols = _TypeBinding_mixin._ReservedSymbols.union({ 'wildcardElements', 'wildcardAttributeMap',
