...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/XMLReport">
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                ...
                <fo:simple-page-master master-name="other_pages" margin-top="10mm" margin-bottom="10mm" margin-left="20mm" margin-right="20mm">
                    <xsl:attribute name="page-width">
                        <xsl:value-of select="$width" />
                    </xsl:attribute>
                    <xsl:attribute name="page-height">
            ...
            <fo:page-sequence master-reference="BSB_REPO_A4">
                <fo:static-content flow-name="xsl-region-after" font-family="Barclays" font-size="6pt">
                    <fo:block padding-bottom="2mm">
                        <fo:external-graphic content-width="40mm" scaling="uniform">
                            <xsl:attribute name="src">
                                <xsl:value-of select="__XMLReportResources/img-member-of-barclays"/>
                            </xsl:attribute>
                        </fo:external-graphic>
                    </fo:block>
                            ...
                            <fo:table-row>
                                <fo:table-cell>
                                    <fo:block margin-bottom="10mm">
                                        <fo:external-graphic content-width="50mm" scaling="uniform">
                                            <xsl:attribute name="src">
                                ...
                                <fo:table-cell>
                                    <fo:block font-family="Helvetica" font-size="10pt" color="red" margin-top="2mm" margin-bottom="3mm">Corporate and Investment Banking</fo:block>
                                    <fo:block font-family="Helvetica" font-size="10pt" color="red" font-weight="bold" margin-bottom="3mm">CONFIDENTIAL</fo:block>
                                    <fo:block font-family="Helvetica" font-size="8pt" color="#303030">
    ...
    <xsl:template match="/XMLReport/Content/Caption">
        <fo:block font-weight="bold" margin-bottom="5mm" font-size="10pt">
            <xsl:value-of select="." />
        </fo:block>
    </xsl:template>

    <xsl:template match="/XMLReport/Content/Table">
        <fo:block border-color="red" padding="2mm" margin-bottom="3mm" border-top-style="solid" border-bottom-style="solid">
            <xsl:choose>
