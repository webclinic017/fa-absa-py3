...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="General">
    ...
    <table class="framed">
      ...
      <tr><td>Ratings Choice List 1:</td><td class="col2"><xsl:value-of select="rating1"/></td></tr>
      <tr><td>Ratings Choice List 2:</td><td class="col2"><xsl:value-of select="rating2"/></td></tr>
      <tr><td>Ratings Choice List 3:</td><td class="col2"><xsl:value-of select="rating3"/></td></tr>
  ...
  <xsl:template match="FConfInstruction">
    ...
    <xsl:apply-templates select="confInstructionRules"/>
    </table>
  </xsl:template>
  <xsl:template match="settleInstructionRules">
  ...
  <xsl:template match="confInstructionRules">
    <xsl:apply-templates select="FConfInstructionRule"/>
  </xsl:template>
  <xsl:template match="FConfInstructionRule">
    <tr><td><br/></td><td><br/></td></tr>
    <tr><td colspan="2" class="col2"><table class="framed">
      <caption class="minor">Confirmation Instruction Rule</caption>
      <tr><td>Template:</td><td><xsl:value-of select="templateChoiceList"/></td></tr>
      <tr><td>STP:</td><td><xsl:value-of select="stp"/></td></tr>
      <tr><td>Type:</td><td><xsl:value-of select="type"/></td></tr>
      <tr><td>Chaser cutoff method:</td><td><xsl:value-of select="chaserCutoffMethod"/></td></tr>
      <tr><td>Chaser cutoff period count:</td><td><xsl:value-of select="chaserCutoffPeriodCount"/></td></tr>
      <tr><td>Sign off group 1:</td><td><xsl:value-of select="signOffGroup1"/></td></tr>
      <tr><td>Sign off group 2:</td><td><xsl:value-of select="signOffGroup2"/></td></tr>
    </table></td></tr>
  </xsl:template>
