...
<!-- &copy; Copyright 2011 SunGard FRONT ARENA
       FStandardTemplateUpdate generates an output which will be automatically refreshed in the web browser every ten seconds.
       Identical to FStandardTemplate except for the autoupdate setting.
-->
...
<xsl:param name="autoupdate" select="1"/>
