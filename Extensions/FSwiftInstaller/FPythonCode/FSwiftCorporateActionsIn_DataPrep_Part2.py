        ...
        for qName in query_list:
            ...
            if not unidentified_bpr:
                ...
                if FSwiftMLUtils.get_acm_version() < 2018.2:
                    ...
                    node.AddAttrNodeString('CurrentStep.State.Name', qName[6:-3], 'EQUAL')
                else:
                    node.AddAttrNodeString('StateChart.Name', sc, 'EQUAL')
                    node.AddAttrNodeString('CurrentStateName', qName[6:-3], 'EQUAL')
...
def run_data_prep(context=''):
    try:
        print(("-"*100))
        print("Running Part-2 of Data Preps for FSwiftCorporateActionsIn")
        print("\nStep-1")
        ...
        print("\n")
        print("FSwiftCorporateActionsIn_DataPrep Part-2 is successfully executed.")
        print(("-"*100))
    except Exception as e:
        print(("Exception in running FSwiftCorporateActionsIn DataPrep Part-2 :", str(e)))
