...
message_types = ['MT600', 'MT620']
STATES = 'Matched'

def create_unidentified_bpr_query():
    """ Create query for Unidentified BPR's """
...
def run_data_prep(context=''):
    ...
    try:
        print(("-"*100))
        print("Running Part-2 of Data Preps for FSwiftCommodityConfirmationIn")
        print("\nStep-1")
        ...
        print("\n")
        print("FSwiftCommodityConfirmationIn Part-2 is successfully executed.")
        print(("-"*100))
    except Exception as e:
        print(("Exception in running FSwiftCommodityConfirmationIn DataPrep Part-2 :", str(e)))
