"""----------------------------------------------------------------------------
MODULE:
    FSwiftSecurityLendingBorrowingOut
...
----------------------------------------------------------------------------"""
from FSwiftSecurityLendingBorrowingOutCallbacks import FSwiftSecurityLendingBorrowingOutCallbacks
notifier = FSwiftWriterLogger.FSwiftWriterLogger('SBL', 'FSwiftSecurityLendingBorrowingOutNotify_Config')

custom_messageout_callback = FSwiftSecurityLendingBorrowingOutCallbacks()
...
def condition_entry_state_ready(context):
    return custom_messageout_callback.condition_entry_state_ready(context)

def condition_entry_state_swiftmsggenerated(context):
    return custom_messageout_callback.condition_entry_state_swiftmsggenerated(context)

def condition_entry_state_generationfailed(context):
    return custom_messageout_callback.condition_entry_state_generationfailed(context)

def condition_entry_state_sendfailed(context):
    return custom_messageout_callback.condition_entry_state_sendfailed(context)

def condition_entry_state_sent(context):
    notifier.INFO('In condition')
    return custom_messageout_callback.condition_entry_state_sent(context)

def condition_entry_state_acknowledged(context):
    return custom_messageout_callback.condition_entry_state_acknowledged(context)

# ------------------------------------------------------------------------------
def condition_exit_state_ready(context):
    return custom_messageout_callback.condition_exit_state_ready(context)

def condition_exit_state_swiftmsggenerated(context):
    return custom_messageout_callback.condition_exit_state_swiftmsggenerated(context)

def condition_exit_state_generationfailed(context):
    return custom_messageout_callback.condition_exit_state_generationfailed(context)

def condition_exit_state_sendfailed(context):
    return custom_messageout_callback.condition_exit_state_sendfailed(context)

def condition_exit_state_sent(context):
    return custom_messageout_callback.condition_exit_state_sent(context)

def condition_exit_state_acknowledged(context):
    return custom_messageout_callback.condition_exit_state_acknowledged(context)
...
def on_entry_state_ready(context):
    custom_messageout_callback.on_entry_state_ready(context)

def on_entry_state_swiftmsggenerated(context):
    custom_messageout_callback.on_entry_state_swiftmsggenerated(context)

def on_entry_state_generationfailed(context):
    custom_messageout_callback.on_entry_state_generationfailed(context)

def on_entry_state_sendfailed(context):
    custom_messageout_callback.on_entry_state_sendfailed(context)

def on_entry_state_sent(context):
    custom_messageout_callback.on_entry_state_sent(context)

def on_entry_state_acknowledged(context):
    custom_messageout_callback.on_entry_state_acknowledged(context)

# ------------------------------------------------------------------------------
def on_exit_state_ready(context):
    custom_messageout_callback.on_exit_state_ready(context)

def on_exit_state_swiftmsggenerated(context):
    custom_messageout_callback.on_exit_state_swiftmsggenerated(context)

def on_exit_state_generationfailed(context):
    custom_messageout_callback.on_exit_state_generationfailed(context)

def on_exit_state_sendfailed(context):
    custom_messageout_callback.on_exit_state_sendfailed(context)

def on_exit_state_sent(context):
    custom_messageout_callback.on_exit_state_sent(context)

def on_exit_state_acknowledged(context):
    custom_messageout_callback.on_exit_state_acknowledged(context)
