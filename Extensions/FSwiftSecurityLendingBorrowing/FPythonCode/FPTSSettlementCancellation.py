...
def condition_entry_state_cancelfailed(context):
    return True
...
def condition_exit_state_cancelled(context):
    return True

def condition_exit_state_cancelfailed(context):
    return True
...
def on_entry_state_cancelfailed(context):
    pass
...
def on_exit_state_cancelled(context):
    pass

def on_exit_state_cancelfailed(context):
    pass
