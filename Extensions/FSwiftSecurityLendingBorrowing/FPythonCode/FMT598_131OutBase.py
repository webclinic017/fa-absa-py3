...
DESCRIPTION:
    This module provides the base class for the FMT598_131 outgoing implementation
...
class FMT598_131Base(FMTOutBase.FMTOutBase):

    def __init__(self, acm_obj, swift_obj, swift_metadata_xml_dom=None):
        self.swift_message_type = "MT598_131"
        self.swift_obj = swift_obj
        self.acm_obj = acm_obj
        super(FMT598_131Base, self).__init__(acm_obj, swift_obj)

    def _message_sequences(self):
        obj = MT598_131.MT598_131_SEQUENCE()
    ...
    # validator
    @validate_with(MT598_131.MT598_131_20_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_12_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_77E_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_23_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_30F_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_30P_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_35A_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_35B_Type)
    ...
    def narrative_79(self):
        return get_narrative_for_598_131(self.acm_obj)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_79_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_26H_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_82B_Type)
    ...
    def counter_party_87C(self):
        return get_counter_party_data(self.acm_obj)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_SEQUENCE_87C_Type)
    ...
    # validator
    @validate_with(MT598_131.MT598_131_18A_Type)
...
class FMT598_131OutBaseMessageHeader(FSwiftWriterMessageHeader.FSwiftWriterMessageHeader):
    def __init__(self, acm_obj, swift_msg_tags, swift_metadata_xml_dom=None):
        ...
        super(FMT598_131OutBaseMessageHeader, self).__init__(self.mt_typ, self.acm_obj, swift_msg_tags)
...
class FMT598_131OutBaseNetworkRules(object):
