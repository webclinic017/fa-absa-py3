"""----------------------------------------------------------------------------
MODULE:
    FSecuritySettlementOutCallbacks
...
import FSecuritySettlementOutCallbacksBase
import FSwiftWriterLogger
notifier = FSwiftWriterLogger.FSwiftWriterLogger('SecSetOut', 'FSecuritySettlementOutNotify_Config')

class FSecuritySettlementOutCallbacks(FSecuritySettlementOutCallbacksBase.FSecuritySettlementOutCallbacksBase):
    def __init__(self):
        super(FSecuritySettlementOutCallbacks, self).__init__()
