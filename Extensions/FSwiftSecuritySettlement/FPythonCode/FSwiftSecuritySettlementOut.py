...
----------------------------------------------------------------------------"""
from FSecuritySettlementOutCallbacks import FSecuritySettlementOutCallbacks

fSecuritySettlementOutCallbacks = FSecuritySettlementOutCallbacks()
...
def condition_entry_state_ready(context):
    return fSecuritySettlementOutCallbacks.condition_entry_state_ready(context)

def condition_entry_state_swiftmsggenerated(context):
    return fSecuritySettlementOutCallbacks.condition_entry_state_swiftmsggenerated(context)

def condition_entry_state_generationfailed(context):
    return fSecuritySettlementOutCallbacks.condition_entry_state_generationfailed(context)

def condition_entry_state_sendfailed(context):
    return fSecuritySettlementOutCallbacks.condition_entry_state_sendfailed(context)

def condition_entry_state_sent(context):
    return fSecuritySettlementOutCallbacks.condition_entry_state_sent(context)

def condition_entry_state_acknowledged(context):
    return fSecuritySettlementOutCallbacks.condition_entry_state_acknowledged(context)

# ------------------------------------------------------------------------------
def condition_exit_state_ready(context):
    return fSecuritySettlementOutCallbacks.condition_exit_state_ready(context)

def condition_exit_state_swiftmsggenerated(context):
    return fSecuritySettlementOutCallbacks.condition_exit_state_swiftmsggenerated(context)

def condition_exit_state_generationfailed(context):
    return fSecuritySettlementOutCallbacks.condition_exit_state_generationfailed(context)

def condition_exit_state_sendfailed(context):
    return fSecuritySettlementOutCallbacks.condition_exit_state_sendfailed(context)

def condition_exit_state_sent(context):
    return fSecuritySettlementOutCallbacks.condition_exit_state_sent(context)

def condition_exit_state_acknowledged(context):
    return fSecuritySettlementOutCallbacks.condition_exit_state_acknowledged(context)
...
def on_entry_state_ready(context):
    fSecuritySettlementOutCallbacks.on_entry_state_ready(context)

def on_entry_state_swiftmsggenerated(context):
    fSecuritySettlementOutCallbacks.on_entry_state_swiftmsggenerated(context)

def on_entry_state_generationfailed(context):
    fSecuritySettlementOutCallbacks.on_entry_state_generationfailed(context)

def on_entry_state_sendfailed(context):
    fSecuritySettlementOutCallbacks.on_entry_state_sendfailed(context)

def on_entry_state_sent(context):
    fSecuritySettlementOutCallbacks.on_entry_state_sent(context)

def on_entry_state_acknowledged(context):
    fSecuritySettlementOutCallbacks.on_entry_state_acknowledged(context)

# ------------------------------------------------------------------------------
def on_exit_state_ready(context):
    fSecuritySettlementOutCallbacks.on_exit_state_ready(context)

def on_exit_state_swiftmsggenerated(context):
    fSecuritySettlementOutCallbacks.on_exit_state_swiftmsggenerated(context)

def on_exit_state_generationfailed(context):
    fSecuritySettlementOutCallbacks.on_exit_state_generationfailed(context)

def on_exit_state_sendfailed(context):
    fSecuritySettlementOutCallbacks.on_exit_state_sendfailed(context)

def on_exit_state_sent(context):
    fSecuritySettlementOutCallbacks.on_exit_state_sent(context)

def on_exit_state_acknowledged(context):
    fSecuritySettlementOutCallbacks.on_exit_state_acknowledged(context)
