"""----------------------------------------------------------------------------
MODULE:
    FSecurityConfirmationInCallbacks

DESCRIPTION:
    OPEN EXTENSION MODULE
    FSecurityConfirmationInCallbacks class for user customization.
    ...
    def condition_entry_state_ready(self):
        ...
        super(FSecurityConfirmationInCallbacks, self).condition_entry_state_ready()
...
----------------------------------------------------------------------------"""
import FSecurityConfirmationInCallbacksBase

class FSecurityConfirmationInCallbacks(FSecurityConfirmationInCallbacksBase.FSecurityConfirmationInCallbacksBase):
    def __init__(self):
        super(FSecurityConfirmationInCallbacks, self).__init__()
