...
DESCRIPTION:
    This module provides the base class for the FMT543 outgoing implementation
...
class FMT543Base(FSecuritySettlementOutBase):

    def __init__(self, acm_obj, swift_obj, swift_metadata_xml_dom=None):
        self.swift_message_type = "MT543"
        self.cfi_code = None
        self.isitc_code = None
        self.security_settlement_out_config = FSwiftMLUtils.Parameters('FSecuritySettlementOut_Config')
        super(FMT543Base, self).__init__(acm_obj, swift_obj, swift_metadata_xml_dom)

    def _message_sequences(self):
        self.swift_obj.SequenceA_GeneralInformation = MT543.MT543_SequenceA_GeneralInformation()
        self.swift_obj.SequenceA_GeneralInformation.swiftTag = "16R"
        self.swift_obj.SequenceA_GeneralInformation.formatTag = "GENL"
        self.swift_obj.SequenceB_TradeDetails = MT543.MT543_SequenceB_TradeDetails()
        self.swift_obj.SequenceB_TradeDetails.swiftTag = "16R"
        self.swift_obj.SequenceB_TradeDetails.formatTag = "TRADDET"
        self.swift_obj.SequenceC_FinancialInstrumentAccount = MT543.MT543_SequenceC_FinancialInstrumentAccount()
        ...
        self.swift_obj.SequenceE_SettlementDetails = MT543.MT543_SequenceE_SettlementDetails()
        ...
        if self.acm_obj.Instrument().IsKindOf(acm.FBond) or self.cfi_code or self.isitc_code:
            self.swift_obj.SequenceB_TradeDetails.SubSequenceB1_FinancialInstrumentAttributes = MT543.MT543_SequenceB_TradeDetails_SubSequenceB1_FinancialInstrumentAttributes()
    ...
    #validator
    @validate_with(MT543.MT543_SequenceA_GeneralInformation_20C_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceA_GeneralInformation_23G_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceA_GeneralInformation_SubSequenceA1_Linkages_20C_Type)
    def _validate_linkages_20C_16R(self, val):
        return val

    #setter
    def _set_linkages_20C_16R(self, val):
        linkage = MT543.MT543_SequenceA_GeneralInformation_SubSequenceA1_Linkages()
    ...
    # validator
    @validate_with(MT543.MT543_SequenceB_TradeDetails_98A_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceB_TradeDetails_SubSequenceB1_FinancialInstrumentAttributes_12A_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceB_TradeDetails_SubSequenceB1_FinancialInstrumentAttributes_12C_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceB_TradeDetails_SubSequenceB1_FinancialInstrumentAttributes_98A_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceB_TradeDetails_SubSequenceB1_FinancialInstrumentAttributes_92A_Type)
    ...
    # validator
    @validate_with(MT543.MT543_SequenceB_TradeDetails_35B_Type)
    ...
    # validator
    @validate_with(MT543.MT543_SequenceC_FinancialInstrumentAccount_36B_Type)
    ...
    # validate
    @validate_with(MT543.MT543_SequenceC_FinancialInstrumentAccount_97A_Type)
    ...
    # validator
    @validate_with(MT543.MT543_SequenceC_FinancialInstrumentAccount_94F_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceE_SettlementDetails_22F_Type)
    ...
    def settlement_parties(self):
        ...
        '''
        """To override tags in SubSequenceE1_SettlementParties block user needs to override set_settlement_parties by changing the specific part"""
        val_list = []
    ...
    def _set_settlement_parties(self, val):
        ...
        for each_val in val:
            setprty = MT543.MT543_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties()
    ...
    # validator
    @validate_with(MT543.MT543_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_95P_Type)
    ...
    # validator
    @validate_with(MT543.MT543_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_95R_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_95C_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_95Q_Type)
    ...
    #validator
    @validate_with(MT543.MT543_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_97A_Type)
    ...
    @validate_with(MT543.MT543_SequenceE_SettlementDetails_SubSequenceE3_Amount_19A_Type)
    def _validate_amounts_19A(self, val):
        return val

    @validate_with(MT543.MT543_SequenceE_SettlementDetails_SubSequenceE3_Amount_17B_Type)
    ...
    def _set_amounts(self, val_dict):
        ...
        for amount in val_dict.get('AMOUNT_BLOCKS'):
            amt = MT543.MT543_SequenceE_SettlementDetails_SubSequenceE3_Amount()
            if 'SETT' in amount:
            ...
            amt.swiftTag = "16R"
            amt.formatTag = "AMT"
            self.swift_obj.SequenceE_SettlementDetails.SubSequenceE3_Amount.append(amt)


class FMT543OutBaseMessageHeader(FSwiftWriterMessageHeader.FSwiftWriterMessageHeader):
    def __init__(self, acm_obj, swift_msg_tags, swift_metadata_xml_dom = None):
        ...
        super(FMT543OutBaseMessageHeader, self).__init__(self.mt_typ, self.acm_obj, swift_msg_tags)
...
class FMT543OutBaseNetworkRules(object):
    ''' '''
    ...
    def network_rule_C1(self):
        ...
        amount_qualifiers = ['ACRU', 'ANTO', 'CHAR', 'COUN', 'DEAL', 'EXEC', 'ISDI', 'LADT', 'LEVY', 'LOCL', 'LOCO',
                             'MARG', 'OTHR', 'REGF', 'SETT', 'SHIP', 'SPCN', 'STAM', 'STEX', 'TRAN', 'TRAX', 'VATA',
                             'WITH', 'COAX', 'ACCA']
        qualifier_repeated = []
    ...
    def network_rule_C5(self):
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
            ...
            dup_qualifier = FSecuritySettlementOutUtils.check_duplicate_qualifier(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', qualifier_list, ['P', 'Q', 'R', 'S', 'C', 'L'])
            if dup_qualifier:
                return 'The party fields %s cannot appear more than once in sequence SubSequenceE1_SettlementParties'%str(dup_qualifier)


        if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE2_CashParties:
            qualifier_list = ['ACCW', 'BENM', 'PAYE', 'DEBT', 'INTM']
            dup_qualifier = FSecuritySettlementOutUtils.check_duplicate_qualifier(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', qualifier_list, ['P', 'Q', 'R', 'S', 'L'])
            if dup_qualifier:
    ...
    def network_rule_C6(self):
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails:
            if self.swift_message_obj.SequenceE_SettlementDetails.Indicator:
                indicator_dbnm_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails, 'Indicator', 'DBNM', [])

                if not indicator_dbnm_flag:
                    if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
                        reag_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'REAG', ['P', 'Q', 'R', 'S', 'C', 'L'])
                        pset_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'PSET', ['P', 'Q', 'R', 'S', 'C', 'L'])

                        if not reag_flag or not pset_flag:
                            return 'If field :22F::DBNM is NOT present in sequence E, then it is mandatory to specify a receiving agent and a place of settlement: one occurrence of the Settlement Parties'
    ...
    def _validate_deliverer_qualifiers(self):
        if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
            dei2_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'DEI2', ['P', 'Q', 'R', 'S', 'C', 'L'])
            dei1_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'DEI1', ['P', 'Q', 'R', 'S', 'C', 'L'])
            decu_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'DECU', ['P', 'Q', 'R', 'S', 'C', 'L'])
            sell_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'SELL', ['P', 'Q', 'R', 'S', 'C', 'L'])
            if dei2_flag:
                if not dei1_flag:
    ...
    def _validate_receiverer_qualifiers(self):
        if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
            rei2_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'REI2', ['P', 'Q', 'R', 'S', 'C', 'L'])
            rei1_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'REI1', ['P', 'Q', 'R', 'S', 'C', 'L'])
            recu_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'RECU', ['P', 'Q', 'R', 'S', 'C', 'L'])
            buyr_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'BUYR', ['P', 'Q', 'R', 'S', 'C', 'L'])
            if rei2_flag:
                if not rei1_flag:
            ...
            if pset_flag:
                ...
                for each_setprty in self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
                    ...
                    for each_option in ['P', 'Q', 'R', 'S', 'C', 'L']:
                        qualifier_exists = FSecuritySettlementOutUtils._check_for_val(each_setprty, 'PARTY', each_option, "PSET")
                        if qualifier_exists:
                            setprty_to_be_checked = each_setprty
                            break
                if setprty_to_be_checked.SafekeepingAccount_A and setprty_to_be_checked.SafekeepingAccount_A.value()[1:5] == 'SAFE':
                    safe_flag = True
                elif setprty_to_be_checked.SafekeepingAccount_B and setprty_to_be_checked.SafekeepingAccount_B.value()[1:5] == 'SAFE':
                    safe_flag = True
    ...
    def network_rule_C10(self):
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails:
            if self.swift_message_obj.SequenceE_SettlementDetails.Indicator:
                ...
                indicator_fxcx_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails, 'Indicator', 'FXCX//FXNO', [])
                indicator_fxye_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails, 'Indicator', 'FXCX//FXYE', [])
                indicator_sino_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails, 'Indicator', 'FXCX//SINO', [])
            ...
            if self.swift_message_obj.SequenceE_SettlementDetails.Indicator:
                ...
                if indicator_dbnm_flag:
                    if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
                        ...
                        party_buyr_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'BUYR', ['P', 'Q', 'R', 'S', 'C', 'L'])
    ...
    def network_rule_C12(self):
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails:
            if self.swift_message_obj.SequenceE_SettlementDetails.Indicator:
                ...
                indicator_dbnm_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails, 'Indicator', 'DBNM//VEND', [])
                if indicator_dbnm_flag:
                    if not self.swift_message_obj.SequenceF_OtherParties:
                        ...
                        party_vend_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceF_OtherParties, 'PARTY', 'VEND', ['P', 'Q', 'R', 'S', 'C', 'L'])
    ...
    def network_rule_C13(self):
        ...
        if self.swift_message_obj.SequenceA_GeneralInformation.SubSequenceA1_Linkages:
            ...
            if flag_36b:
                if self.swift_message_obj.SequenceE_SettlementDetails:
                    indicator_pair_off_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails, 'Indicator', 'SETR//PAIR', [])
                    indicator_turn_around_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails, 'Indicator', 'SETR//TURN', [])
    ...
    def network_rule_C15(self):
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE3_Amount:
            ...
            if valu_date_flag:
                if self.swift_message_obj.SequenceE_SettlementDetails.Indicator:
                    indicator_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails, 'Indicator', 'STCO//SPST', [])
                if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE3_Amount:
    ...
    field :97a:: is not allowed in the same sequence"""
        if self.swift_message_obj.SequenceF_OtherParties:
            flag_95a = False
            flag_95a_exch = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceF_OtherParties, 'PARTY', 'EXCH', ['P', 'Q', 'R', 'S', 'C', 'L'])
            if not flag_95a_exch:
                flag_95a_trre = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceF_OtherParties, 'PARTY', 'TRRE', ['P', 'Q', 'R', 'S', 'C', 'L'])
                ...
                if flag_95a_exch:
                    for each_othrprty in self.swift_message_obj.SequenceF_OtherParties:
                        if sequence_f_to_be_checked:
                            break
                        for each_option in ['P', 'Q', 'R', 'S', 'C', 'L']:
                            qualifier_exists = FSecuritySettlementOutUtils._check_for_val(each_othrprty, 'PARTY', each_option, "EXCH")
                            if qualifier_exists:
                ...
                if flag_95a_trre:
                    for each_othrprty in self.swift_message_obj.SequenceF_OtherParties:
                        if sequence_f_to_be_checked:
                            break
                        for each_option in ['P', 'Q', 'R', 'S', 'C', 'L']:
                            qualifier_exists = FSecuritySettlementOutUtils._check_for_val(each_othrprty, 'PARTY', each_option, "TRRE")
                            if qualifier_exists:
                                sequence_f_to_be_checked = each_othrprty
                                break
    ...
    def network_rule_C17(self):
        ...
        flag_95_acow = False
        if self.swift_message_obj.SequenceC_FinancialInstrumentAccount:
            flag_95L_alte = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceC_FinancialInstrumentAccount, 'Party', 'ALTE', ['L'])
            if flag_95L_alte:
                flag_95_acow = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceC_FinancialInstrumentAccount, 'Party', 'ACOW', ['L', 'P', 'R'])
                if not flag_95_acow:
    ...
    def _validate_c18_1(self):
        ...
        if self.swift_message_obj.SequenceB_TradeDetails:
            count_clea = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceB_TradeDetails, 'Place', 'CLEA', ['L', 'B', 'H'])
            if count_clea > 2:
                return 'In sequence B, field :94a::CLEA must not be present more than twice.'
            if count_clea == 2:
                count_format_l = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceB_TradeDetails, 'Place', 'CLEA', ['L'])
                if count_format_l > 1:
    ...
    def _validate_c18_2(self):
        ...
        if self.swift_message_obj.SequenceB_TradeDetails:
            count_trad = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceB_TradeDetails, 'Place', 'TRAD', ['L', 'B', 'H'])
            if count_trad > 2:
                return 'In sequence B, field :94a::TRAD must not be present more than twice.'
            if count_trad == 2:
                count_format_l = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceB_TradeDetails, 'Place', 'TRAD', ['L'])
                if count_format_l > 1:
    ...
    def _validate_c18_3(self):
        ...
        if self.swift_message_obj.SequenceC_FinancialInstrumentAccount:
            count_safe = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceC_FinancialInstrumentAccount, 'PlaceOfSafekeeping', 'SAFE', ['B', 'C', 'F', 'L'])
            if count_safe > 2:
                return 'In sequence C, field :94a::SAFE must not be present more than twice.'
            if count_safe == 2:
                count_format_l = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceC_FinancialInstrumentAccount, 'PlaceOfSafekeeping', 'SAFE', ['L'])
                if count_format_l > 1:
    ...
    def _validate_c18_4(self):
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
            count_alte = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'ALTE', ['L', 'Q', 'P', 'R', 'S', 'C'])
            if count_alte > 2:
                return 'In each occurrence of subsequence E1, field :95a::ALTE must not be present more than twice.'
            if count_alte == 2:
                count_format_l = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'ALTE', ['L'])
                if count_format_l > 1:
    ...
    def _validate_c18_5(self):
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE2_CashParties:
            count_alte = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE2_CashParties, 'PARTY', 'ALTE', ['L', 'P', 'R', 'Q', 'S'])
            if count_alte > 2:
                return 'In each occurrence of subsequence E1, field :95a::ALTE must not be present more than twice.'
            if count_alte == 2:
                count_format_l = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE2_CashParties, 'PARTY', 'ALTE', ['L'])
                if count_format_l > 1:
    ...
    def _validate_c18_6(self):
        ...
        repeated, one and only one occurrence must be with format option L (:95L::ALTE)"""
        if self.swift_message_obj.SequenceF_OtherParties:
            count_alte = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceF_OtherParties, 'PARTY', 'ALTE', ['C', 'P', 'R', 'Q', 'S'])
            if count_alte > 2:
                return 'In each occurrence of sequence F, field :95a::ALTE must not be present more than twice.'
            if count_alte == 2:
                count_format_l = FSecuritySettlementOutUtils.qualifier_count(self.swift_message_obj.SequenceF_OtherParties, 'PARTY', 'ALTE', ['L'])
                if count_format_l > 1:
    ...
    def network_rule_C19(self):
        ...
        if self.swift_message_obj.SequenceF_OtherParties:
            alte_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceF_OtherParties, 'PARTY', 'ALTE', ['L'])
            if alte_flag:
                sequence_f_to_be_checked = None
                for each_othrprty in self.swift_message_obj.SequenceF_OtherParties:
                    ...
                    if qualifier_exists:
                        ...
                        break
                if sequence_f_to_be_checked:
                   meor_flag = FSecuritySettlementOutUtils._check_for_val(sequence_f_to_be_checked, 'PARTY', ['P', 'Q', 'R', 'S', 'C', 'L'], "MEOR")
                   mere_flag = FSecuritySettlementOutUtils._check_for_val(sequence_f_to_be_checked, 'PARTY', ['P', 'Q', 'R', 'S', 'C', 'L'], "MERE")
