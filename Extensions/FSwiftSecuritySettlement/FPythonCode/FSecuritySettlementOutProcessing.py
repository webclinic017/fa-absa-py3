"""----------------------------------------------------------------------------
MODULE:
    FSecuritySettlementOutProcessing
...
import FSecuritySettlementOutProcessingBase

class FSecuritySettlementOutProcessing(FSecuritySettlementOutProcessingBase.FSecuritySettlementOutProcessingBase):
    def __init__(self, bpr):
        super(FSecuritySettlementOutProcessing, self).__init__(bpr)
