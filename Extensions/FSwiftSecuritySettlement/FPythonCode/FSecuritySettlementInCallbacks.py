"""----------------------------------------------------------------------------
MODULE:
    FSecuritySettlementInCallbacks

DESCRIPTION:
    OPEN EXTENSION MODULE
    FSecuritySettlementInCallbacks class for user customization.
    ...
    def condition_entry_state_ready(self):
        ...
        super(FSecuritySettlementInCallbacks, self).condition_entry_state_ready()
...
----------------------------------------------------------------------------"""
import FSecuritySettlementInCallbacksBase

class FSecuritySettlementInCallbacks(FSecuritySettlementInCallbacksBase.FSecuritySettlementInCallbacksBase):
    def __init__(self):
        super(FSecuritySettlementInCallbacks, self).__init__()
