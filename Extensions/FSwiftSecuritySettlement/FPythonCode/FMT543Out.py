...
class FMT543(FMT543OutBase.FMT543Base):
    ...
    def __init__(self, acm_obj, swift_obj, swift_metadata_xml_dom = None):
        super(FMT543, self).__init__(acm_obj, swift_obj, swift_metadata_xml_dom)
...
class FMT543MessageHeader(FMT543OutBase.FMT543OutBaseMessageHeader):
    ...
    def __init__(self, acm_obj, swift_msg_tags, swift_metadata_xml_dom=None):
        ...
        super(FMT543MessageHeader, self).__init__(acm_obj, swift_msg_tags, swift_metadata_xml_dom)
...
class FMT543NetworkRules(FMT543OutBase.FMT543OutBaseNetworkRules):
    ...
    def __init__(self, swift_message_obj, swift_message, acm_obj, swift_metadata_xml_dom = None):
        super(FMT543NetworkRules, self).__init__(swift_message_obj, swift_message, acm_obj, swift_metadata_xml_dom)
