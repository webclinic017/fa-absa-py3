...
class FMT541(FMT541OutBase.FMT541Base):
    ...
    def __init__(self, acm_obj, swift_obj, swift_metadata_xml_dom = None):
        super(FMT541, self).__init__(acm_obj, swift_obj, swift_metadata_xml_dom)
...
class FMT541MessageHeader(FMT541OutBase.FMT541OutBaseMessageHeader):
    ...
    def __init__(self, acm_obj, swift_msg_tags, swift_metadata_xml_dom = None):
        ...
        super(FMT541MessageHeader, self).__init__(acm_obj, swift_msg_tags, swift_metadata_xml_dom)
...
class FMT541NetworkRules(FMT541OutBase.FMT541OutBaseNetworkRules):
    ...
    def __init__(self, swift_message_obj, swift_message, acm_obj, swift_metadata_xml_dom = None):
        super(FMT541NetworkRules, self).__init__(swift_message_obj, swift_message, acm_obj, swift_metadata_xml_dom)
