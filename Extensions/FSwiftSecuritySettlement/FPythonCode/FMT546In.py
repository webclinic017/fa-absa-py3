...
DESCRIPTION:
    ...
    FMT546 class for user customization.
...
class FMT546(FMT54XInBase.FMT54XBase):
    """ FMT546 class for user customization"""
    def __init__(self, source, direction):
        super(FMT546, self).__init__(source, direction, 'MT546')
    ...
    def SetAttributes(self):
        super(FMT546, self).SetAttributes()
        self.CustomMappings()
