...
DESCRIPTION:
    This module provides the base class for the FMT540 outgoing implementation
...
class FMT540Base(FSecuritySettlementOutBase):

    def __init__(self, acm_obj, swift_obj, swift_metadata_xml_dom=None):
        self.swift_message_type = "MT540"
        super(FMT540Base, self).__init__(acm_obj, swift_obj, swift_metadata_xml_dom)

    def _message_sequences(self):
        self.swift_obj.SequenceA_GeneralInformation = MT540.MT540_SequenceA_GeneralInformation()
        self.swift_obj.SequenceA_GeneralInformation.swiftTag = "16R"
        self.swift_obj.SequenceA_GeneralInformation.formatTag = "GENL"
        self.swift_obj.SequenceB_TradeDetails = MT540.MT540_SequenceB_TradeDetails()
        self.swift_obj.SequenceB_TradeDetails.swiftTag = "16R"
        self.swift_obj.SequenceB_TradeDetails.formatTag = "TRADDET"
        self.swift_obj.SequenceC_FinancialInstrumentAccount = MT540.MT540_SequenceC_FinancialInstrumentAccount()
        ...
        self.swift_obj.SequenceE_SettlementDetails = MT540.MT540_SequenceE_SettlementDetails()
    ...
    # validator
    @validate_with(MT540.MT540_SequenceA_GeneralInformation_23G_Type)
    ...
    # validator
    @validate_with(MT540.MT540_SequenceA_GeneralInformation_SubSequenceA1_Linkages_20C_Type)
    def _validate_linkages_20C_16R(self, val):
        return val

    # setter
    def _set_linkages_20C_16R(self, val):
        linkage = MT540.MT540_SequenceA_GeneralInformation_SubSequenceA1_Linkages()
    ...
    # validator
    @validate_with(MT540.MT540_SequenceB_TradeDetails_98A_Type)
   ...
   # ------------------ identification of financial instruments -----------------------
    ...
    # validator
    @validate_with(MT540.MT540_SequenceB_TradeDetails_35B_Type)
    ...
    @validate_with(MT540.MT540_SequenceC_FinancialInstrumentAccount_36B_Type)
    ...
    # validator
    @validate_with(MT540.MT540_SequenceC_FinancialInstrumentAccount_97A_Type)
    ...
    # validator
    @validate_with(MT540.MT540_SequenceC_FinancialInstrumentAccount_94F_Type)
    ...
    @validate_with(MT540.MT540_SequenceE_SettlementDetails_22F_Type)
    ...
    def _set_settlement_parties(self, val):
        ...
        for each_val in val:
            setprty = MT540.MT540_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties()
    ...
    # validator
    @validate_with(MT540.MT540_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_95P_Type)
    ...
    # validator
    @validate_with(MT540.MT540_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_95R_Type)
    ...
    # validator
    @validate_with(MT540.MT540_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_95C_Type)
    ...
    # validator
    @validate_with(MT540.MT540_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_95Q_Type)
    ...
    # validator
    @validate_with(MT540.MT540_SequenceE_SettlementDetails_SubSequenceE1_SettlementParties_97A_Type)
...
class FMT540OutBaseMessageHeader(FSwiftWriterMessageHeader.FSwiftWriterMessageHeader):
    def __init__(self, acm_obj, swift_msg_tags, swift_metadata_xml_dom=None):
        ...
        super(FMT540OutBaseMessageHeader, self).__init__(self.mt_typ, self.acm_obj, swift_msg_tags)
...
class FMT540OutBaseNetworkRules(object):
    ...
    def network_rule_C1(self):
        ...
        amount_qualifiers = ['ACRU', 'ANTO', 'BOOK', 'CHAR', 'COUN', 'DEAL', 'EXEC', 'ISDI', 'LADT', 'LEVY', 'LOCL',
                             ...
                             'ACCA']
        amount_qualifier_flag = {'ACRU': False, 'ANTO': False, 'BOOK': False, 'CHAR': False, 'COUN': False,
                                 'DEAL': False, 'EXEC': False, 'ISDI': False, \
                                 'LADT': False, 'LEVY': False, 'LOCL': False, 'LOCO': False, 'MARG': False,
                                 'OTHR': False, 'REGF': False, \
                                 'SETT': False, 'SHIP': False, 'SPCN': False, 'STAM': False, 'STEX': False,
                                 'TRAN': False, 'TRAX': False, \
                                 'VATA': False, 'WITH': False, 'COAX': False, 'ACCA': False}
        qualifier_repeated = []
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE3_Amount:
            for qualifier in amount_qualifiers:
                for amounts in self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE3_Amount:
                    qualifier_flag = self._check_for_val(amounts.Amount, qualifier)
                    if qualifier_flag:
                ...
                if amounts.ExchangeRate:
                    ...
                    for amount in amounts.Amount:
                        if amount.swiftTag == '19A' and amount.value().startswith(':RESU'):
                            ...
                            break
                    if res_amt_flag:
                        error_msg = "In subsequence E3, If the exchange rate is not present then the Resulting Amount is not allowed"
                        return error_msg
    ...
    def network_rule_C4(self):
        ...
        if self.swift_message_obj.SequenceF_OtherParties:
            qualifier_list = ['EXCH', 'MEOR', 'MERE', 'TRRE', 'VEND', 'TRAG', 'BRKR']
    ...
    def network_rule_C5(self):
        '''If field :22F::DBNM is NOT present in sequence E, then it is mandatory to specify a delivering agent
        and a place of settlement: one occurrence of subsequence E1 Settlement Parties'''
                ...
                if not indicator_dbnm_flag:
                    if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
                        deag_flag = FSecuritySettlementOutUtils.check_qualifier_exists(
                            self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'DEAG', ['P', 'Q', 'R', 'S', 'C'])
                        pset_flag = FSecuritySettlementOutUtils.check_qualifier_exists(
                            self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'PSET', ['P', 'Q', 'R', 'S', 'C'])
        ...
        if self.swift_message_obj.SequenceE_SettlementDetails:
            if self.swift_message_obj.SequenceE_SettlementDetails.Indicator:
                ...
                if indicator_sino_flag:
                    if self.swift_message_obj.SequenceA_GeneralInformation.FunctionOfTheMessage.value() != 'NEWM':
    ...
    def network_rule_C10(self):
        """If field :22F::DBNM is present in sequence E, then a seller must be specified, that is one occurrence of
        subsequence E1 must contain field :95a::SELL"""
        if self.swift_message_obj.SequenceE_SettlementDetails:
            if self.swift_message_obj.SequenceE_SettlementDetails.Indicator:
                indicator_dbnm_flag = FSecuritySettlementOutUtils.check_qualifier_exists(self.swift_message_obj.SequenceE_SettlementDetails,
                                                                                        'Indicator', 'DBNM', [])
                if indicator_dbnm_flag:
                    if self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties:
                        party_sell_flag = False
                        party_sell_flag = FSecuritySettlementOutUtils.check_qualifier_exists(
                            self.swift_message_obj.SequenceE_SettlementDetails.SubSequenceE1_SettlementParties, 'PARTY', 'SELL', ['P', 'Q', 'R', 'S', 'C', 'L'])
                        if not party_sell_flag:
                            return 'If field :22F::DBNM is present in sequence E, then a buyer must be specified, that is one occurrence of subsequence E1 must contain field :95a::SELL'
        return ''
