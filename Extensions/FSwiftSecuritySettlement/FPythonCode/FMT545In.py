...
DESCRIPTION:
    ...
    FMT545 class for user customization.
    ...
    See FMT54XInBase for extracting the values from swift or an acm

VERSION: 3.0.0-0.5.3344
----------------------------------------------------------------------------"""
import FMT54XInBase

class FMT545(FMT54XInBase.FMT54XBase):
    """ FMT545 class for user customization"""
    def __init__(self, source, direction):
        super(FMT545, self).__init__(source, direction, 'MT545')
    ...
    def SetAttributes(self):
        super(FMT545, self).SetAttributes()
        self.CustomMappings()
