"""----------------------------------------------------------------------------
MODULE:
    FSwiftClientStmtOfHoldingInCallbacks

DESCRIPTION:
    OPEN EXTENSION MODULE
    FSwiftClientStmtOfHoldingInCallbacks class for user customization.
    ...
    def condition_entry_state_ready(self):
        ...
        super(FSwiftClientStmtOfHoldingInCallbacks, self).condition_entry_state_ready()
...
----------------------------------------------------------------------------"""
import FSwiftClientStmtOfHoldingInCallbacksBase

class FSwiftClientStmtOfHoldingInCallbacks(FSwiftClientStmtOfHoldingInCallbacksBase.FSwiftClientStmtOfHoldingInCallbacksBase):
    def __init__(self):
        super(FSwiftClientStmtOfHoldingInCallbacks, self).__init__()
