...
DESCRIPTION:
    ...
    FMT535 class for user customization.
    User can override the mapping defined in the base class FMT535InBase.
    This class can be populated using either swift data or an acm object.
    See FMT535InBase for extracting the values from swift #or an acm
...
class FMT535(FMT535InBase.FMT535Base):
    """ FMT547 class for user customization"""

    def __init__(self, source, direction):
        super(FMT535, self).__init__(source, direction, 'MT535')
    ...
    def SetAttributes(self):
        super(FMT535, self).SetAttributes()
        self.CustomMappings()
    ...
    def GetColumnMetaData():
        ...
        column_metadata = FMT535InBase.FMT535Base.GetColumnMetaData()
