"""----------------------------------------------------------------------------
MODULE:
    FSwiftSettStatusProcessAdviceInCallbacks

DESCRIPTION:
    OPEN EXTENSION MODULE
    FSwiftSettStatusProcessAdviceInCallbacks class for user customization.
    Business process conditional_entry/exit and on_entry/exit callbacks.
    User can override the logic written in the base class
    FSwiftSettStatusProcessAdviceInCallbacks
    ...
    def condition_entry_state_ready(self):
        ...
        super(FSwiftSettStatusProcessAdviceInCallbacks, self).condition_entry_state_ready()
...
----------------------------------------------------------------------------"""
import FSecuritySettlementStatusProcessAdviceInCallbacksBase

class FSecuritySettlementStatusProcessAdviceInCallbacks(FSecuritySettlementStatusProcessAdviceInCallbacksBase.FSecuritySettlementStatusProcessAdviceInCallbacksBase):
    def __init__(self):
        super(FSecuritySettlementStatusProcessAdviceInCallbacks, self).__init__()
