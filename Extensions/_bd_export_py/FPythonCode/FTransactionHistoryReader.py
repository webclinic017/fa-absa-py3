...
#__src_file__ = "extensions/BDExport/./etc/FTransactionHistoryReader.py"
...
class FPastTradeStatusTransitions():
    ...
    def __init__(self, integrationID, query, tradeStatusTransitions, tradeFilterFunction = None):
    ...
    def StoredTradeQueries(self):
        return FExportUtils.TradeFilterQueriesForIntegration(self._query)
