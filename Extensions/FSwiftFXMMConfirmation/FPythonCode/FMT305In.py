...
DESCRIPTION:
    ...
    FMTIn305 class for user customization.
    User can override the mapping defined in the base class FMT305InBase.
    This class can be populated using either swift data or an acm object.
    See FMT305InBase for extracting the values from swift or an acm

VERSION: 3.0.1-0.5.3470
----------------------------------------------------------------------------"""
import FMT305InBase

class FMT305(FMT305InBase.FMT305Base):
    """ FMT300 class for user customization"""
    def __init__(self, source, direction):
        super(FMT305, self).__init__(source, direction)
    ...
    def SetAttributes(self):
        super(FMT305, self).SetAttributes()
        self.CustomMappings()
    ...
    def GetColumnMetaData():
        ...
        column_metadata = FMT305InBase.FMT305Base.GetColumnMetaData()
