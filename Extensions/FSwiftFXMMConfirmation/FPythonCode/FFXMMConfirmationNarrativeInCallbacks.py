"""----------------------------------------------------------------------------
MODULE:
    FFXMMConfirmationNarrativeInCallbacks

DESCRIPTION:
    OPEN EXTENSION MODULE
    FFXMMConfirmationInCallbacks class for user customization.
    Business process conditional_entry/exit and on_entry/exit callbacks.
    User can override the logic written in the base class FFXMMConfirmationNarrativeInCallbacksBase
    ...
    def condition_entry_state_ready(self):
        ...
        super(FFXMMConfirmationNarrativeInCallbacks, self).condition_entry_state_ready()
...
import FFXMMConfirmationNarrativeInCallbacksBase


class FFXMMConfirmationNarrativeInCallbacks(FFXMMConfirmationNarrativeInCallbacksBase.FFXMMConfirmationNarrativeInCallbacksBase):
    def __init__(self):
        super(FFXMMConfirmationNarrativeInCallbacks, self).__init__()
