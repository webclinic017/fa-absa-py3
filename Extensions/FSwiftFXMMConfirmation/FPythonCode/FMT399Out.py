...
DESCRIPTION:
    ...
    FMT399 class for user customization.
    User can override the mapping defined in the base class FMT399OutBase.
...
class FMT399(FMTx99OutBase.FMTx99Base):

	def __init__(self, acm_obj, swift_obj, swift_metadata_xml_dom=None):
		swift_message_type = 'MT399'
		super(FMT399, self).__init__(acm_obj, swift_message_type, swift_obj, swift_metadata_xml_dom)
...
class FMT399MessageHeader(FMTx99OutBase.FMTx99OutBaseMessageHeader):
	...
	def __init__(self, acm_obj, swift_msg_tags, swift_metadata_xml_dom=None):
		...
		self.mt_type = '399'
		super(FMT399MessageHeader, self).__init__(acm_obj, self.mt_type, swift_msg_tags)
...
class FMT399NetworkRules(FMTx99OutBase.FMTx99OutBaseNetworkRules):

	def __init__(self, swift_message_obj, swift_message, acm_obj):
		super(FMT399NetworkRules, self).__init__(swift_message_obj, swift_message, acm_obj)
