...
DESCRIPTION:
    ...
    FMTIn399 class for user customization.
    User can override the mapping defined in the base class FMTx99InBase.
    This class can be populated using either swift data or an acm object.
    See FMTx99InBase for extracting the values from swift or an acm
...
class FMT399(FMTx99InBase.FMTx99Base):
	""" FMT300 class for user customization"""

	def __init__(self, source, direction):
		super(FMT399, self).__init__(source, direction, 'MT399')
	...
	def SetAttributes(self):
		super(FMT399, self).SetAttributes()
		self.CustomMappings()
	...
	def GetColumnMetaData():
		...
		column_metadata = FMTx99InBase.FMTx99Base.GetColumnMetaData()
