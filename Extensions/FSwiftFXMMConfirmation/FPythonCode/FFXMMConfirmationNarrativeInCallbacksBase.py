"""----------------------------------------------------------------------------
MODULE:
    FFXMMConfirmationNarrativeInCallbacksBase

DESCRIPTION:
    OPEN EXTENSION MODULE
    This is a READ ONLY module. User can override the default logic in derived
    class FFXMMConfirmationNarrativeInCallbacks
...
class FFXMMConfirmationNarrativeInCallbacksBase(object):
    def __init__(self):
        pass
    ...
    def condition_entry_state_pairedwithparty(self, context):
        return FSwiftMLUtils.HasUserRights(FSwiftMLUtils.get_operation_name_from_bpr_context(context))
...
# ------------------------------------------------------------------------------
    ...
    def condition_exit_state_pairedwithparty(self, context):
        return True
...
# ------------------------------------------------------------------------------
    ...
    def on_entry_state_pairedwithparty(self, context):
        pass
...
# ------------------------------------------------------------------------------
    ...
    def on_exit_state_pairedwithparty(self, context):
        pass
