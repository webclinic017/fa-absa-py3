...
DESCRIPTION:
    ...
    User can override the logic written in the base class FFXMMConfirmationInCallbacksBase
    ...
    def condition_entry_state_ready(self):
        ...
        super(FFXMMConfirmationInCallbacks, self).condition_entry_state_ready()
...
import FFXMMConfirmationInCallbacksBase


class FFXMMConfirmationInCallbacks(FFXMMConfirmationInCallbacksBase.FFXMMConfirmationInCallbacksBase):
    def __init__(self):
        super(FFXMMConfirmationInCallbacks, self).__init__()
