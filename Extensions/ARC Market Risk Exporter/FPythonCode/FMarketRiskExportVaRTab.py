...
#__src_file__ = "extensions/arc_writers/./etc/FMarketRiskExportVaRTab.py"
"""----------------------------------------------------------------------------
MODULE
