...
from QuoteRequestReplyUtil import MethodDirection, Misc
from DealPackageUtil import UnpackPaneInfo

class QuoteRequestReplyDealPackageBase(DealPackageDefinition):
    ...
    ***********************************************************************************************'''  
    def CustomPanesName(self):
        return 'CustomPanes_QuoteRequestReply'
        
    def DealPackageCustomPanes(self):
        return Misc.DealPackageCustomPanes(self.DelegatedDealPackage(), self.GetCustomPanesFromExtValue)
