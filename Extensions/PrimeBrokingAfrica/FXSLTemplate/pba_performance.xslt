        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="page_sequence">
                ...
                <fo:static-content flow-name="xsl-region-after-last">
                    ...
                    <fo:block text-align="left" font-size="8pt"> - All prices are in instrument's currency</fo:block>
                    <fo:block text-align="left" font-size="8pt"> - All amounts are in instrument's currency</fo:block>
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
                        ...
                        <fo:table-column column-width="16mm"/><!-- Closing Position -->
                        <fo:table-column column-width="12mm"/><!-- Opening Price -->
                        <fo:table-column column-width="18mm"/><!-- Opening Value End -->
                        <fo:table-column column-width="12mm"/><!-- Closing Price -->
                        <fo:table-column column-width="18mm"/><!-- Closing Value End -->
                        <fo:table-column column-width="18mm"/><!-- Closing Resets -->
                        <fo:table-column column-width="18mm"/><!-- Closing Other Fee -->
                        <fo:table-column column-width="16mm"/><!-- Provision End -->
                        <fo:table-column column-width="17mm"/><!-- Since Inception Fee -->
                        <fo:table-column column-width="17mm"/><!-- Since Inception Commission -->
                        ...
                        <fo:table-column column-width="18mm"/><!-- YTD PnL -->
                        <fo:table-column column-width="18mm"/><!-- Since Inception PnL -->
                        <fo:table-header>
