			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="18mm"/> <!-- Date and Time -->
						<fo:table-column column-width="25mm"/> <!-- Instrument -->
                        <fo:table-column column-width="18mm"/> <!-- Acquire Date -->
						<fo:table-column column-width="10mm"/> <!-- Side -->
						<fo:table-column column-width="18mm"/> <!-- Qty/Nominal -->
						<fo:table-column column-width="12mm"/> <!-- Trade Price -->
						<fo:table-column column-width="12mm"/> <!-- Deal Rate -->
                        <fo:table-column column-width="20mm"/> <!-- Trade Consideration -->
						<fo:table-column column-width="20mm"/> <!-- Fees -->
						<fo:table-column column-width="20mm"/> <!-- Commission -->
						<fo:table-column column-width="20mm"/> <!-- Net Consideration -->
						<fo:table-column column-width="20mm"/> <!-- Country of trade -->
						<fo:table-column column-width="20mm"/> <!-- Total Consideration ZAR -->
                        <fo:table-column column-width="15mm"/> <!-- FX Rate to ZAR -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Deal</fo:block>
									<fo:block text-align="right" font-weight="bold">Rate</fo:block>
								</fo:table-cell>
                                <fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Trade</fo:block>
								...
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Fees</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Commission</fo:block>
								</fo:table-cell>
								<fo:table-cell>
								...
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Country</fo:block>
									<fo:block text-align="right" font-weight="bold">of</fo:block>
									<fo:block text-align="right" font-weight="bold">Trade</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Consideration</fo:block>
									<fo:block text-align="right" font-weight="bold">ZAR</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">FX Rate</fo:block>
									<fo:block text-align="right" font-weight="bold">to ZAR</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-header>
						<fo:table-body>
						...
						<fo:table-body>
							<fo:table-row border-top="solid black 1pt">
								<fo:table-cell>
									...
									<fo:block text-align="left" font-family="SansSerif" font-size="8pt" margin-left="3mm">- All prices are in particular country's currency</fo:block>
									<fo:block text-align="left" font-family="SansSerif" font-size="8pt" margin-left="3mm">- All amounts are in particular country's currency</fo:block>
