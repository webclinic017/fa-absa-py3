...
<xsl:stylesheet version="1.0"
                    ...
                    <fo:table table-layout="fixed" width="100%">
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                ...
                                <fo:table-cell>
                                    <fo:block font-family="Helvetica" font-size="10pt" color="rgb(220, 0, 50)" margin-top="2mm" margin-bottom="3mm">Corporate and Investment Banking</fo:block>
                                    <fo:block font-family="Helvetica" font-size="10pt" color="rgb(220, 0, 50)" font-weight="bold" margin-bottom="3mm">CONFIDENTIAL</fo:block>
    ...
    <xsl:template match="/XMLReport/Content/Table">
		<xsl:choose>
		  <xsl:when test="@tableheader">
			<fo:block>
				<fo:block keep-with-next.within-page="always" font-weight="bold" font-size="10pt" margin-top="5mm">
	...
	<xsl:template name="Table">
		<fo:block border-color="rgb(220, 0, 50)" padding="2mm" margin-bottom="3mm" border-top-style="solid" border-bottom-style="solid" font-weight="normal" font-size="8pt">
            <xsl:choose>
