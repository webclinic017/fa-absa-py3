# C:\Projects\Swift_Integration_ap\base\extensions\SwiftIntegration\FCashSettlement\Outgoing\XSD\MT292.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:96afad3d20bbfe8d040a1a097fa388d9fecd10e3
# Generated 2019-10-23 17:50:21.475666 by PyXB version 1.2.6 using Python 3.7.4.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:7b7ee928-f58f-11e9-a079-484d7e9b1690')
...
class MT292_11S_Type_Pattern(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
        3, 1)
    _Documentation = None


MT292_11S_Type_Pattern._CF_pattern = pyxb.binding.facets.CF_pattern()
MT292_11S_Type_Pattern._CF_pattern.addPattern(
...
MT292_20_Type_Pattern._CF_pattern.addPattern(
    pattern="([^/]([a-zA-Z0-9]|/|-|\\?|:|\\(|\\)|\\.|,|'|\\+|\\n|\\s){1,16}[^/])")
...
MT292_21_Type_Pattern._CF_pattern.addPattern(
    pattern="([^/]([a-zA-Z0-9]|/|-|\\?|:|\\(|\\)|\\.|,|'|\\+|\\n|\\s){1,16}[^/])")
...
MT292_79_Type_Pattern._CF_pattern.addPattern(
    pattern="((([a-zA-Z0-9]|/|-|\\?|:|\\(|\\)|\\.|,|'|\\+|\\n|\\s){1,50}\\n?){1,35})")
...
class MT292_11S_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    __swiftTag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'swiftTag'), 'swiftTag',
                                                   '__httpwww_w3schools_com_MT292_11S_Type_swiftTag',
    ...
    __isMandatory = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'isMandatory'), 'isMandatory',
                                                      '__httpwww_w3schools_com_MT292_11S_Type_isMandatory',
...
class MT292_20_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute swiftTag uses Python identifier swiftTag
    __swiftTag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'swiftTag'), 'swiftTag',
                                                   '__httpwww_w3schools_com_MT292_20_Type_swiftTag',
                                                   pyxb.binding.datatypes.anySimpleType, fixed=True,
                                                   unicode_default='20')
    __swiftTag._DeclarationLocation = pyxb.utils.utility.Location(
        'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
    ...
    # Attribute isMandatory uses Python identifier isMandatory
    __isMandatory = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'isMandatory'), 'isMandatory',
                                                      '__httpwww_w3schools_com_MT292_20_Type_isMandatory',
                                                      pyxb.binding.datatypes.anySimpleType, unicode_default='True')
    __isMandatory._DeclarationLocation = pyxb.utils.utility.Location(
        'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
        25, 4)
...
class MT292_21_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute swiftTag uses Python identifier swiftTag
    __swiftTag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'swiftTag'), 'swiftTag',
                                                   '__httpwww_w3schools_com_MT292_21_Type_swiftTag',
                                                   pyxb.binding.datatypes.anySimpleType, fixed=True,
                                                   unicode_default='21')
    __swiftTag._DeclarationLocation = pyxb.utils.utility.Location(
        'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
    ...
    # Attribute isMandatory uses Python identifier isMandatory
    __isMandatory = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'isMandatory'), 'isMandatory',
                                                      '__httpwww_w3schools_com_MT292_21_Type_isMandatory',
                                                      pyxb.binding.datatypes.anySimpleType, unicode_default='True')
    __isMandatory._DeclarationLocation = pyxb.utils.utility.Location(
        'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
        38, 4)
...
class MT292_79_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    # Attribute swiftTag uses Python identifier swiftTag
    __swiftTag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'swiftTag'), 'swiftTag',
                                                   '__httpwww_w3schools_com_MT292_79_Type_swiftTag',
                                                   pyxb.binding.datatypes.anySimpleType, fixed=True,
                                                   unicode_default='79')
    __swiftTag._DeclarationLocation = pyxb.utils.utility.Location(
        'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
    ...
    # Attribute isMandatory uses Python identifier isMandatory
    __isMandatory = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'isMandatory'), 'isMandatory',
                                                      '__httpwww_w3schools_com_MT292_79_Type_isMandatory',
...
MT292 = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MT292'), CTD_ANON,
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TransactionReferenceNumber'), MT292_20_Type,
                               scope=CTD_ANON, location=pyxb.utils.utility.Location(
            'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
            58, 4)))

CTD_ANON._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RelatedReference'), MT292_21_Type,
                               scope=CTD_ANON, location=pyxb.utils.utility.Location(
            'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
            59, 4)))

CTD_ANON._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MTAndDateOfTheOriginalMessage'), MT292_11S_Type,
                               scope=CTD_ANON, location=pyxb.utils.utility.Location(
            'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
            60, 4)))
...
CTD_ANON._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'NarrativeDescriptionOfTheOriginalMessage'),
                               MT292_79_Type, scope=CTD_ANON, location=pyxb.utils.utility.Location(
            'C:\\Projects\\Swift-Integration_ap\\base\\extensions\\SwiftIntegration\\FCashSettlement\\Outgoing\\XSD\\MT292.xsd',
            61, 4)))
