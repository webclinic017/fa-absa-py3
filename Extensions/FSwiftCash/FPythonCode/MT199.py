...
# Generated 2019-10-24 12:05:01.771379 by PyXB version 1.2.6 using Python 3.7.4.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:68038da2-f628-11e9-8454-484d7e9b1690')
...
class MT199_20_Type_Pattern(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 3, 1)
    _Documentation = None


MT199_20_Type_Pattern._CF_pattern = pyxb.binding.facets.CF_pattern()
MT199_20_Type_Pattern._CF_pattern.addPattern(
    pattern="([^/]([a-zA-Z0-9]|/|-|\\?|:|\\(|\\)|\\.|,|'|\\+|\\n|\\s){1,16}[^/])")
...
class MT199_21_Type_Pattern(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 16, 1)
    _Documentation = None


MT199_21_Type_Pattern._CF_pattern = pyxb.binding.facets.CF_pattern()
MT199_21_Type_Pattern._CF_pattern.addPattern(
    pattern="([^/]([a-zA-Z0-9]|/|-|\\?|:|\\(|\\)|\\.|,|'|\\+|\\n|\\s){1,16}[^/])")
...
class MT199_79_Type_Pattern(pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 29, 1)
    _Documentation = None


MT199_79_Type_Pattern._CF_pattern = pyxb.binding.facets.CF_pattern()
MT199_79_Type_Pattern._CF_pattern.addPattern(
    pattern="((([a-zA-Z0-9]|/|-|\\?|:|\\(|\\)|\\.|,|'|\\+|\\n|\\s){1,50}\\n?){1,35})")
...
class CTD_ANON(pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 43, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __TransactionReferenceNumber = pyxb.binding.content.ElementDeclaration(
        ...
        pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 45, 4), )
    ...
    __RelatedReference = pyxb.binding.content.ElementDeclaration(
        ...
        pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 46, 4), )
    ...
    __Narrative = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Narrative'),
                                                          ...
                                                          False,
                                                          pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 47, 4), )
...
class MT199_20_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 8, 1)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __swiftTag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'swiftTag'), 'swiftTag',
                                                   '__httpwww_w3schools_com_MT199_20_Type_swiftTag',
                                                   pyxb.binding.datatypes.anySimpleType, fixed=True,
                                                   unicode_default='20')
    __swiftTag._DeclarationLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 11, 4)
    __swiftTag._UseLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 11, 4)
    ...
    __isMandatory = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'isMandatory'), 'isMandatory',
                                                      '__httpwww_w3schools_com_MT199_20_Type_isMandatory',
                                                      pyxb.binding.datatypes.anySimpleType, unicode_default='True')
    __isMandatory._DeclarationLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 12, 4)
    __isMandatory._UseLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 12, 4)
...
class MT199_21_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    # Attribute swiftTag uses Python identifier swiftTag
    __swiftTag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'swiftTag'), 'swiftTag',
                                                   '__httpwww_w3schools_com_MT199_21_Type_swiftTag',
                                                   pyxb.binding.datatypes.anySimpleType, fixed=True,
                                                   unicode_default='21')
    __swiftTag._DeclarationLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 24, 4)
    __swiftTag._UseLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 24, 4)

    swiftTag = property(__swiftTag.value, __swiftTag.set, None, None)

    # Attribute isMandatory uses Python identifier isMandatory
    __isMandatory = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'isMandatory'), 'isMandatory',
                                                      '__httpwww_w3schools_com_MT199_21_Type_isMandatory',
                                                      pyxb.binding.datatypes.anySimpleType, unicode_default='False')
    __isMandatory._DeclarationLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 25, 4)
    __isMandatory._UseLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 25, 4)
...
class MT199_79_Type(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 34, 1)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    # Attribute swiftTag uses Python identifier swiftTag
    __swiftTag = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'swiftTag'), 'swiftTag',
                                                   '__httpwww_w3schools_com_MT199_79_Type_swiftTag',
                                                   pyxb.binding.datatypes.anySimpleType, fixed=True,
                                                   unicode_default='79')
    __swiftTag._DeclarationLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 37, 4)
    __swiftTag._UseLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 37, 4)

    swiftTag = property(__swiftTag.value, __swiftTag.set, None, None)

    # Attribute isMandatory uses Python identifier isMandatory
    __isMandatory = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'isMandatory'), 'isMandatory',
                                                      '__httpwww_w3schools_com_MT199_79_Type_isMandatory',
                                                      pyxb.binding.datatypes.anySimpleType, unicode_default='True')
    __isMandatory._DeclarationLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 38, 4)
    __isMandatory._UseLocation = pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 38, 4)
...
MT199 = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MT199'), CTD_ANON,
                                   location=pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 42, 1))
Namespace.addCategoryObject('elementBinding', MT199.name().localName(), MT199)

CTD_ANON._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TransactionReferenceNumber'), MT199_20_Type,
                               scope=CTD_ANON, location=pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 45, 4)))

CTD_ANON._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RelatedReference'), MT199_21_Type,
                               scope=CTD_ANON, location=pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 46, 4)))

CTD_ANON._AddElement(
    pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Narrative'), MT199_79_Type, scope=CTD_ANON,
                               location=pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 47, 4)))
...
def _BuildAutomaton():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('C:\\Apurva\\MT199.xsd', 46, 4))
    counters.add(cc_0)
    states = []
    final_update = None
