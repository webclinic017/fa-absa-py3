...
def ael_custom_dialog_main( parameters, dictExtra ):
    ...
    shiftVector = acm.CreateShiftVector( 'shiftCurveZeroCouponPeriods', 'forward curve', GetCriteria( parameters ), acm.FYieldCurveFilter, GetCriteriaTopOnly( parameters ) )
