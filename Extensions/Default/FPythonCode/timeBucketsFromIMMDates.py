...
def ael_custom_dialog_show(shell, params):
    ...
    return TimeBucketHelperFunctions.ShowCreateBucketsFromCDSOrIMMDialog(shell, params, 'IMM Adjusted Buckets')
...
def CreateBuckets( parameters ):
    ...
    return TimeBucketHelperFunctions.CreateIMMOrCDSTimeBucketDefinitions(startDate, numberOfBucketInput, 'IMM')
