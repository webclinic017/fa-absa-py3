...
#__src_file__ = "extensions/trade_rollout/FTradeRollout.py"
#----------------------------------------------------------------------------
...
def ael_main(dictionary):
    ...
    FBDPCurrentContext.CreateLog('Trade Rollout',
                      dictionary['Logmode'],
    ...
    FBDPCommon.execute_script(FTradeRolloutPerform.perform_rollout, dictionary)
