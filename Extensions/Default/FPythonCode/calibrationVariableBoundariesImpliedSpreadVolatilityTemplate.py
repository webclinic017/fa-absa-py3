...
['impliedvolatilitymin', 'Implied Volatility min', 'double', None, -100.0, 1, 0, '', None, True],
['impliedvolatilitymax', 'Implied Volatility max', 'double', None, 1000.0, 1, 0, '', None, True],
