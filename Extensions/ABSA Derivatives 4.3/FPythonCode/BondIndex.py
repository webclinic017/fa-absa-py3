...
def index_value(bond_index,marketSpotValue, *rest):
    ...
    index_calcs = bond_index_calculations(bond_index, weights, vd, sd)
...
def update_bond_index_price(ins):
    ''' Over-writes the spot price with the theor price for a bond index. 
    '''
    
    ins_theor = index_value(ins)
