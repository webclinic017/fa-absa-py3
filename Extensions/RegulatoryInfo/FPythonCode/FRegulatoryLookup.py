...
#__src_file__ = "extensions/RegulatoryInfo/../SwiftIntegration/RegulatoryInfo/RegulatoryInfoLib/Adaptations/FRegulatoryLookup.py"
import acm, ael
...
class RTS2Classification(object):
    ...
    def CreditDefaultSwap_rts2(self):
        ...
        if self.__instrument.Underlying().InsType() in ['Combination', 'CreditIndex']:
            ins_type = 'Basket CDS'
        if rts2_ins_type_lookup.has_key(ins_type):
    ...
    def CreditDefaultSwap_rts2_sub_type(self):
        ...
        if self.__instrument.Underlying().InsType() in ['Combination', 'CreditIndex']:
            ins_type = 'Basket CDS'
        if rts2_sub_ins_type_lookup.has_key(ins_type):
    ...
    def mifid2_rts2_instype(self):
        ins_type = ''
        if rts2_ins_type_lookup.has_key(self.__instrument.InsType()):
    ...
    def mifid2_rts2_inssubtype(self):
        ins_type = ''
        if rts2_sub_ins_type_lookup.has_key(self.__instrument.InsType()):
