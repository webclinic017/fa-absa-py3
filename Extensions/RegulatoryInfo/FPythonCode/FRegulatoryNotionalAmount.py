...
#__src_file__ = "extensions/RegulatoryInfo/../SwiftIntegration/RegulatoryInfo/RegulatoryInfoLib/FRegulatoryNotionalAmount.py"
"""------------------------------------------------------------------------
MODULE
...
class FRegulatoryNotionalAmount(object):
    ...
    def notional_amount(self):
        ...
        notional_amount = None
        try:
            if instrument_type in ['Bill', 'Bond', 'Convertible', 'Zero', 'FRN', 'IndexLinkedBond', 'PromisLoan',\
            ...
            elif instrument_type in ['PriceSwap', 'FXOptionDatedFwd', 'Average_Future_Forward']:
            ...
            elif (instrument_type == 'Curr' and self.__trade.IsFxSwap()) or instrument_type in ['VarianceSwap', 'VolatilitySwap']:
