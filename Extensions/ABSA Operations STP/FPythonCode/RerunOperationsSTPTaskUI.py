...
class MenuItem(FUxCore.MenuItem):
    ...
    def Invoke(self, eii):
        ...
        import RerunOperationsSTPTask
        acm.RunModuleWithParameters(RerunOperationsSTPTask.__name__, acm.GetDefaultContext())
    ...
    def _user_has_access():
        ...
        menu item.
        """
        return acm.User().IsAllowed('Rerun Operations STP', 'Application')
