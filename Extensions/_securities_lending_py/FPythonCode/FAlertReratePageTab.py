...
#__src_file__ = "extensions/SecuritiesLending/etc/FAlertReratePageTab.py"
...
class AlertReratePage(AlertPage):
    
    _SETTINGS = ParameterSettingsCreator.FromRootParameter('AlertReratePage')
