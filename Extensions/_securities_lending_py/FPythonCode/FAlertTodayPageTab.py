...
#__src_file__ = "extensions/SecuritiesLending/etc/FAlertTodayPageTab.py"
import acm, ael
import FSheetUtils
...
class AlertTodayPage(AlertPage):
    
    _SETTINGS = ParameterSettingsCreator.FromRootParameter('AlertTodayPage')

    TAB_NAME = 'Processed Today'
