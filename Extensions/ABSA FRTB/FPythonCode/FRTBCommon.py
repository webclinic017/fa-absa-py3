...
global INTERNAL_ISSUERS
INTERNAL_ISSUERS = None
...
def getInternalIssuers():
    global INTERNAL_ISSUERS
    
    if INTERNAL_ISSUERS == None:
        print ('Setting the INTERNAL ISSUER list.')
        internalIssuers = acm.FInternalDepartment.Select('issuer = Yes')
        INTERNAL_ISSUERS = [internalIssuer.Name() for internalIssuer in internalIssuers ]
    return INTERNAL_ISSUERS
