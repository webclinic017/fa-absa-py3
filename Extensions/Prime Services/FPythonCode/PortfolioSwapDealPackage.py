"""
Prime Services version of PrimePortfolioSwapDefinition.

Overrides the same module from Synthetic Prime.
Needs to be manually updated with every Prime upgrade.

Lines marked with # override are the Prime services
customizations over the original version.

------------------------------------------------------
01-08-2019  Iryna Shcherbina    Upgrade to Prime 2018.4
"""
...
class PortfolioSwapDefinition(DealPackageDefinition):
    ...
    acquirer = Object(               label='Acquirer',
                                     ...
                                     choiceListSource="@CounterpartyChoices" )  # override
    ...
    def CounterpartyChoices(self, *args):
        parties  = acm.FArray()  # override
        parties.AddAll(acm.FParty.Select('type="Intern Dept"'))  # override
        parties.AddAll(acm.FParty.Select('type="Counterparty"'))  # override
        return parties  # override
    ...
    def FilteredPortfolioQueryFolderImpl(self):
	    ...
	    insTypeNode = query.AddOpNode('OR')  # override
            insTypeNode.AddAttrNode('Instrument.Cid', 'EQUAL', 'Stock')  # override
            insTypeNode.AddAttrNode('Instrument.Cid', 'EQUAL', 'ETF')  # override
