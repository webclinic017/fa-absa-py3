			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="25mm"/><!-- OTC/Exchange -->
						<fo:table-column column-width="25mm"/><!-- ISIN -->
						<fo:table-column column-width="24mm"/><!-- VALUE START -->
						...
						<fo:table-column column-width="28mm"/><!-- Total Funding -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell padding-right="2.5mm">
									...
									<fo:block text-align="right"  font-weight="bold">Start</fo:block>
								</fo:table-cell>
								<fo:table-cell>
								...
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">Funding</fo:block>
								...
								<fo:table-cell padding-right="2.5mm">
									<fo:block text-align="right"  font-weight="bold">All in</fo:block>
									<fo:block text-align="right"  font-weight="bold">Rate</fo:block>
								</fo:table-cell>
								<fo:table-cell>
