...
<?xml version="1.0"?>
<!-- This template is a successor of ps_finance_report - it's supposed to work under the "new" prime services reporting suite. -->
            ...
            <fo:page-sequence master-reference="page_sequence">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
                        ...
                        <fo:table-column column-width="25mm"/><!-- ISIN -->
                        <fo:table-column column-width="20mm"/><!-- Opening Price -->
                        <fo:table-column column-width="20mm"/><!-- Opening Position -->
                        <fo:table-column column-width="24mm"/><!-- Opening MTM -->
                        <fo:table-column column-width="13mm" border-collapse="collapse" border-left-style="solid"/><!-- Reference Rate -->
                        <fo:table-column column-width="16mm"/><!-- Funding Spread -->
                        <fo:table-column column-width="16mm"/><!-- SBL Rate -->
                        <fo:table-column column-width="16mm" border-collapse="collapse" border-right-style="solid"/><!-- All in Rate -->
                        <fo:table-column column-width="24mm"/><!-- Daily Funding -->
                        <fo:table-header>
                            <fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
                                ...
                                <fo:table-cell>
                                    <fo:block text-align="left"  font-weight="bold">Opening</fo:block>
                                    <fo:block text-align="left"  font-weight="bold">Price</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="left"  font-weight="bold">Opening</fo:block>
                                    <fo:block text-align="left"  font-weight="bold">Position</fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding-right="2.5mm">
                                    <fo:block text-align="right"  font-weight="bold">Opening</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">MTM</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Reference</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Rate</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Financing</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Spread</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">SBL</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Spread</fo:block>
                                </fo:table-cell>
                                <fo:table-cell padding-right="2.5mm">
