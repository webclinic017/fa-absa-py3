...
<?xml version="1.0"?>
<!-- A descendant of ps_cash_transaction_report, meant to be used in conjunction with the PB_CallAccount workbook. -->
		...
		<fo:root>
			...
			<fo:page-sequence master-reference="first">
				...
				<fo:flow flow-name="xsl-region-body">
					<xsl:apply-templates select="/PRIMEReport/ReportContents/Table/Rows/Row"/>
				</fo:flow>
			</fo:page-sequence>
		</fo:root>
	</xsl:template>
	<xsl:template match="Row">
		<fo:table table-layout="fixed" font-size="8pt" border-spacing="2pt" break-after="page">
			...
			<fo:table-body  table-layout="fixed" font-size="8pt" border-spacing="2pt">
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						<fo:table-cell padding="2.5pt">
							<fo:block text-align="left">Daily TPL (incl backdates)</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding="2.5pt">
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						<fo:table-cell padding="2.5pt">
							<fo:block text-align="left">Margin Required Equity</fo:block>
						</fo:table-cell>
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						<fo:table-cell padding="2.5pt">
							<fo:block text-align="left">Margin Required Fixed Income</fo:block>
						</fo:table-cell>
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						<fo:table-cell padding="2.5pt">
							<fo:block text-align="left">Margin Required Credit</fo:block>
						</fo:table-cell>
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						<fo:table-cell padding="2.5pt">
							<fo:block text-align="left">Margin Required Total</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding="2.5pt">
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						<fo:table-cell padding="2.5pt">
							<fo:block text-align="left">Collateral (Non Cash) Available</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding="2.5pt" border-left-style="solid" border-left-width="1pt" border-top-style="solid" border-top-width="1pt" border-right-style="solid" border-right-width="1pt">
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						<fo:table-cell padding="2.5pt">
							<fo:block text-align="left">Collateral (Non Cash) Utilized</fo:block>
						</fo:table-cell>
						<fo:table-cell  padding="2.5pt" border-left-style="solid" border-left-width="1pt" border-bottom-style="solid" border-bottom-width="1pt" border-right-style="solid" border-right-width="1pt">
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						<fo:table-cell padding="2.5pt">
							<fo:block text-align="left">Due <xsl:if test="Cells/Cell[15]/RawData &lt; 0">From You</xsl:if><xsl:if test="Cells/Cell[15]/RawData &gt; 0">To You</xsl:if></fo:block>
						</fo:table-cell>
					...
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						...
						<fo:table-cell  padding="2.5pt">
							<fo:block text-align="right"><xsl:value-of select="Cells/Cell[16]/FormattedData"/></fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row border-bottom-style="dotted"  border-bottom-color="Gray">
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
						...
						<fo:table-cell  padding="2.5pt">
							<fo:block text-align="right">
								<xsl:value-of select="Cells/Cell[17]/FormattedData"/></fo:block>
						</fo:table-cell>
					</fo:table-row>
					<fo:table-row border-bottom-style="dotted"  border-bottom-color="Gray">
					<xsl:attribute name="background-color">#f1f1f1</xsl:attribute>
