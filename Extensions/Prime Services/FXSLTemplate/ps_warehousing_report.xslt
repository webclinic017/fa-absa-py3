			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="20mm"/><!-- Maturity -->
						<fo:table-column column-width="17mm"/><!-- Remaining Maturity -->
						<fo:table-column column-width="30mm"/><!-- Notional -->
						<fo:table-column column-width="22mm"/><!-- Warehousing Rate -->
						<fo:table-column column-width="22mm"/><!-- Daily Warehousing -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">Remaining</fo:block>
									<fo:block text-align="right"  font-weight="bold">Maturity</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">Notional</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">Warehousing</fo:block>
