...
&comma;Benchmark Delta&comma;&comma;&comma;Curve Move
Benchmark&comma;Non Overlapping&comma;Overlapping&comma;Total&comma;T-1&comma;T&comma;Change&comma;PnL Expect
<xsl:for-each select="//ReportDetail/ReportRow">
<xsl:value-of select="@Label"/>&comma;
<xsl:value-of select="NonOver"/>&comma;
<xsl:value-of select="Over"/>&comma;
