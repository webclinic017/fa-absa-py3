			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="13.5mm"/><!-- PV01 -->
						<fo:table-column column-width="13.5mm"/><!-- 1D -->
						<fo:table-column column-width="13.5mm"/><!-- 3M -->
						<fo:table-column column-width="13.5mm"/><!-- 6M -->
						<fo:table-column column-width="13.5mm"/><!-- 9M -->
						<fo:table-column column-width="13.5mm"/><!-- 12M -->
						<fo:table-column column-width="13.5mm"/><!-- 15M -->
						<fo:table-column column-width="13.5mm"/><!-- 18M -->
						<fo:table-column column-width="13.5mm"/><!-- 21M -->
						<fo:table-column column-width="13.5mm"/><!-- 2Y -->
						<fo:table-column column-width="13.5mm"/><!-- 5Y -->
						<fo:table-column column-width="13.5mm"/><!-- 10Y -->
						<fo:table-column column-width="13.5mm"/><!-- 15Y -->
						<fo:table-column column-width="13.5mm"/><!-- 20Y -->
						<fo:table-column column-width="13.5mm"/><!-- 25Y -->
						<fo:table-column column-width="13.5mm"/><!-- 30Y -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">1D</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">3M</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold"> 6M</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">9M</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">12M</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">15M</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">18M</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">21M</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">2Y</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">5Y</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">10Y</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">15Y</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">20Y</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">25Y</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">30Y</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-header>
						<fo:table-body>
