			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="20mm"/><!-- ClosingPrice -->
						<fo:table-column column-width="30mm"/><!-- Closing Market Exposure-->
						<fo:table-column column-width="30mm"/><!-- Daily PnL -->
						<fo:table-column column-width="30mm"/><!-- Monthly PnL -->
						<fo:table-column column-width="30mm"/><!-- Yearly PnL -->
						<fo:table-header>
