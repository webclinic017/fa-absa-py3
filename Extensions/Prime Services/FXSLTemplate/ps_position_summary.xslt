            ...
            <fo:page-sequence master-reference="page_sequence">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
                        ...
                        <fo:table-column column-width="18mm"/><!-- Financing Method -->
                        <fo:table-column column-width="16mm"/><!-- Start Date -->
                        <fo:table-column column-width="16mm"/><!-- Maturity Date -->
                        <fo:table-column column-width="10mm"/><!-- Fixed Rate -->
                        <fo:table-column column-width="18mm"/><!-- Closing Price -->
                        <fo:table-column column-width="20mm"/><!-- Closing Position -->
                        <fo:table-column column-width="18mm"/><!-- Closing Value End -->
                        <fo:table-column column-width="18mm"/><!-- NAV Accrued Value -->
                        <fo:table-column column-width="18mm"/><!-- NAV Fair Value -->
                        <fo:table-column column-width="18mm"/><!-- NAV Gross Exposure -->
                        <fo:table-column column-width="18mm"/><!-- NAV Net Exposure -->
                        <fo:table-column column-width="18mm"/><!-- Market Exposure -->
                        <fo:table-column column-width="14mm"/><!-- Yield Delta -->
                        <fo:table-header>
                            <fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
                                ...
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Fixed</fo:block>
                                ...
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">NAV Accrued</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Value</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">NAV Fair</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Value</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">NAV Gross</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Exposure</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">NAV Net</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Exposure</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Market</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Exposure</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Yield</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Delta</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-header>
                        <fo:table-body>
