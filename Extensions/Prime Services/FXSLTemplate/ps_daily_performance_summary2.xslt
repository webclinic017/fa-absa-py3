            ...
            <fo:page-sequence master-reference="page_sequence">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
                        ...
                        <fo:table-column column-width="20mm"/><!-- Position change -->
                        <fo:table-column column-width="20mm"/><!-- ClosingPosition -->
                        <fo:table-column column-width="16mm"/><!-- ClosingPrice -->
                        <fo:table-column column-width="30mm"/><!-- Closing Market Exposure -->
                        <fo:table-column column-width="25mm"/><!-- MTM PnL -->
                        <fo:table-column column-width="20mm"/><!-- Provision -->
                        <fo:table-column column-width="20mm"/><!-- Funding -->
                        <fo:table-column column-width="15mm"/><!-- Execution Charge -->
                        <fo:table-column column-width="15mm"/><!-- STT -->
                        <fo:table-column column-width="15mm"/><!-- VAT -->
                        <fo:table-column column-width="27mm"/><!-- Total PnL -->
                        <fo:table-header>
                            <fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
                                ...
                                <fo:table-cell>
                                    ...
                                    <fo:block text-align="left"  font-weight="bold">Change</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                ...
                                <fo:table-cell>
                                    ...
                                    <fo:block text-align="right"  font-weight="bold">Charge</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">STT</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">VAT</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Daily</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">PnL</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-header>
                        <fo:table-body>
