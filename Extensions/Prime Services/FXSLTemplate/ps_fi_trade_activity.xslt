			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="18mm"/>						<!-- InsType -->
						<fo:table-column column-width="35mm"/>						<!-- Underlying -->
						<fo:table-column column-width="20mm"/>						<!-- Reference -->
						...
						<fo:table-column column-width="17mm"/>						<!-- Nominal -->
						...
						<fo:table-column column-width="17mm"/>						<!-- VAT -->
						...
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell>
									...
									<fo:block text-align="left" font-weight="bold">and Time</fo:block>
								</fo:table-cell>
								<fo:table-cell>
								...
								<fo:table-cell>
									<fo:block text-align="left" font-weight="bold">Reference</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="left" font-weight="bold">Settlement</fo:block>
									<fo:block text-align="left" font-weight="bold">Date</fo:block>
								</fo:table-cell>
								<fo:table-cell>
