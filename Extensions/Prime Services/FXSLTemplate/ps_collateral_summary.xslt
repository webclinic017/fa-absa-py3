			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						<fo:table-column column-width="80mm"/><!-- Label -->					      <fo:table-column column-width="proportional-column-width(1)"/><!-- Collateral Type -->
						<fo:table-column column-width="90mm"/><!-- Fair Value -->
						<fo:table-column column-width="20mm"/><!-- Haircut % -->
						<fo:table-column column-width="30mm"/><!-- Collateral Value -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								<fo:table-cell>
									<fo:block text-align="left"  font-weight="bold">Instrument</fo:block>
																...
																<fo:table-cell>
									<fo:block text-align="left"  font-weight="bold">Collateral</fo:block>
									<fo:block text-align="left"  font-weight="bold">Type</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">Fair</fo:block>
									<fo:block text-align="right"  font-weight="bold">Value</fo:block>
								</fo:table-cell>

								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">Haircut(%)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right"  font-weight="bold">Collateral</fo:block>
									<fo:block text-align="right"  font-weight="bold">Value</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-header>
	...
	<xsl:template match="Row">
		...
		<fo:table-row border-bottom-style="dotted" border-bottom-color="Gray">
            ...
            <fo:table-cell display-align="center">
				...
				<xsl:if test="$treeDepth='2' ">
					<fo:block text-align="left" vertical-align="middle">
						Total Category <xsl:value-of select="Label"/>
					</fo:block>
				</xsl:if>
				<xsl:if test="$treeDepth>'3' ">
					<fo:block text-align="left" vertical-align="middle">
