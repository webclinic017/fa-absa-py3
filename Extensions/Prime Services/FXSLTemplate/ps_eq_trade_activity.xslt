			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="30mm"/>						<!-- Date and Time -->
						<fo:table-column column-width="15mm"/>						<!-- OTC/Exchange -->
						<fo:table-column column-width="20mm"/>						<!-- Instrument Type -->
						<fo:table-column column-width="35mm"/>						<!-- Instrument -->
						<fo:table-column column-width="10mm"/>						<!-- B/S -->
						<fo:table-column column-width="12mm"/>						<!-- Qty -->
						<fo:table-column column-width="15mm"/>						<!-- Price -->
						<fo:table-column column-width="24mm"/>						<!-- Trade Consideration -->
						<fo:table-column column-width="24mm"/>						<!-- Execution Charge -->
						<fo:table-column column-width="15mm"/>						<!-- STT -->
						<fo:table-column column-width="15mm"/>						<!-- VAT -->
						<fo:table-column column-width="24mm"/>						<!-- Total Consideration -->
                                                                                                <fo:table-column column-width="24mm"/>						<!-- Fund Identifier -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell>
									...
									<fo:block text-align="right" font-weight="bold">Consideration</fo:block>
                                                                                                                                ...
                                                                                                                                <fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Fund</fo:block>
									<fo:block text-align="right" font-weight="bold">Identifier</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-header>
						<fo:table-body>
