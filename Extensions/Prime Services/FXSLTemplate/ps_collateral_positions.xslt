            ...
            <fo:page-sequence master-reference="page_sequence">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
                        ...
                        <fo:table-column column-width="20mm"/><!-- Start Date -->
                        <fo:table-column column-width="20mm"/><!-- Expiry -->
                        <fo:table-column column-width="20mm"/><!-- OTC/Exchange -->
                        <fo:table-column column-width="20mm"/><!-- Option Type -->
                        <fo:table-column column-width="20mm"/><!-- Closing Price -->
                        <fo:table-column column-width="25mm"/><!-- Closing Position -->
                        <fo:table-column column-width="25mm"/><!-- Position Change -->
                        <fo:table-column column-width="25mm"/><!-- Closing Market Value -->
                        <fo:table-column column-width="20mm"/><!-- Yield Delta -->
                        <fo:table-header>
                            <fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
                                ...
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">OTC/</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Exchange</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Option</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Type</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                ...
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Change in</fo:block>
                                    <fo:block text-align="right"  font-weight="bold">Position</fo:block>
                                </fo:table-cell>
                                <fo:table-cell>
                                ...
                                <fo:table-cell>
                                    <fo:block text-align="right"  font-weight="bold">Yield Delta</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-header>
                        <fo:table-body>
