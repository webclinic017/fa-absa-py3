...
#__src_file__ = "extensions/MarkitSecuritiesFinance/etc/FMarkitPerform.py"
...
class FBDPPerform(WorldInterface):
    """
    The FBDPPerform template class.
    """

    def __init__(self, world):
        WorldInterface.__init__(self, world)
