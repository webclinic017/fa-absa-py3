...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_REQT_ST_01_ATS
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Front Cache Request Type Single Trade
                                ATS. This ATS will know how to handel a SINGLE TRADE requests and to pass it
                                onto a Trade Collection ATS. Because SINGLE TRADE requests are only based on 1
                                trade, this ATS can be seen as a pass through ATS.
...
try:
    from FC_REQT_ST_ATS_WORKER import FC_REQT_ST_ATS_WORKER as REQT_ST_ATS_WORKER
except ImportError, e:
