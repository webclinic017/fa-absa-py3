...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_ISCOLL_01_ATS_01
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Instrument Sensitivity Collection ATSs.
                                These ATSs will subscribe to Instrument Sensitivity Collection Requests. They
                                will pull the relevant Front Cache data from Front Cache Trading Manager
                                Template for the specific Instrument Sensitivities in the incoming request.
...
try:
    from FC_ISCOLL_ATS_WORKER import FC_ISCOLL_ATS_WORKER as ISCOLL_ATS_WORKER
except ImportError, e:
