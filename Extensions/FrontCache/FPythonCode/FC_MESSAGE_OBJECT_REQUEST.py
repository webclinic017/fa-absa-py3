...
----------------------------------------------------------------------------------------------------------'''
class FC_MESSAGE_OBJECT_REQUEST(MESSAGE_OBJECT_BASE.FC_MESSAGE_OBJECT_BASE):
    def __init__(self):
        MESSAGE_OBJECT_BASE.FC_MESSAGE_OBJECT_BASE.__init__(self)        
        self.buildControlMeasures = False
        self.senderSubject = ''
        ...
        self.requestCollectionTrackerId = 0
        self.requestCollectionPrimaryKeys = ''
