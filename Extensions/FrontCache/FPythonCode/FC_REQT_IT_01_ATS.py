...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_REQT_IT_01_ATS
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Front Cache Request Type Instrument Trades
                                ATS. This ATS will know how to handel a INSTRUMENT TRADES requests and to pass it
                                onto a Trade Collection ATS.
...
try:
    from FC_REQT_IT_ATS_WORKER import FC_REQT_IT_ATS_WORKER as REQT_IT_ATS_WORKER
except ImportError, e:
