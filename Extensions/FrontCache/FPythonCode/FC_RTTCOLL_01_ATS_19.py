...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_RTTCOLL_01_ATS_19
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Realtime Trade ATSs. These ATSs will
                                subscribe to Realtime Trade Requests. They will pull the relevant Front Cache
                                data from Front Cache Trading Manager Template for the specific trades in the
...
try:
    from FC_RTTCOLL_ATS_WORKER import FC_RTTCOLL_ATS_WORKER as RTTCOLL_ATS_WORKER
except ImportError, e:
