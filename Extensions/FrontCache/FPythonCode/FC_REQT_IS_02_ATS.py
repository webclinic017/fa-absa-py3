...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_REQT_IS_02_ATS
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Front Cache Request Type Instrument
                                Sensitivity ATS. This ATS will pick up the Instrument Sensitivity Request
                                and transform it into a Instrument Sensitivity Collection AMBA message which
                                will be processed by one of the Instrument Sensitivity Collection ATSs.
...
try:
    from FC_REQT_IS_ATS_WORKER import FC_REQT_IS_ATS_WORKER as REQT_IS_ATS_WORKER
except ImportError, e:
