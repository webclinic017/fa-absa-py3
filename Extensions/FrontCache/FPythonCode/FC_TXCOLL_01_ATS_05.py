...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_SCOLL_01_ATS_01
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the STL Collection ATSs. These ATSs will
                                subscribe to STL Collection Requests. They will pull the relevant Front Cache
                                data from Front Cache Tradign Manager Template for the specific stl's in the
...
try:
    from FC_TXCOLL_ATS_WORKER import FC_TXCOLL_ATS_WORKER as TXCOLL_ATS_WORKER
except ImportError, e:
