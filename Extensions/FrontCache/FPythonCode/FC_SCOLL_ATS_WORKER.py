'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_SCOLL_ATS_WORKER
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the base module for Settlement Collection ATSs. It will connect to the
                                AMB and prcess Settlement Collection Requests. It will retreive the data from Front
...
from FC_DATA_STL_BUILDER_OPTIONS import FC_DATA_STL_BUILDER_OPTIONS as  fcDataSettlementBuilderOptions
...
----------------------------------------------------------------------------------------------------------'''
class FC_SCOLL_ATS_WORKER(COLL_ATS_WORKER_BASE.FC_COLL_ATS_WORKER_BASE):
    def __init__(self):
    ...
    def SaveData(self, requestId, reportDate, startIndex, numbers, buildControlMeasures, retryCount, requestType, scopeName):
        self._buildOptions =   fcDataSettlementBuilderOptions()
        ...
        return DATA_HELPER.BuildAndSaveSettlements(requestId, reportDate, startIndex, numbers, self._buildOptions, retryCount)
