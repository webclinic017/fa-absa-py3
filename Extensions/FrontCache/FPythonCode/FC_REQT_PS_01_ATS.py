...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_REQT_PS_01_ATS
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Front Cache Request Type Portfolio
                                Sensitivity ATS. This ATS will pick up the Portfolios Sensitivity Request and
                                transform it into a Portfolios Sensitivity Collection AMBA message which will
                                be processed by one of the Portfolios Sensitivity Collection ATSs.
...
try:
    from FC_REQT_PS_ATS_WORKER import FC_REQT_PS_ATS_WORKER as REQT_PS_ATS_WORKER
except ImportError, e:
