...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_REQT_PT_01_ATS
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Front Cache Request Type Portfolio Trades
                                ATS. This ATS will pick up the Portfolios Trades Request and transform it into
                                a Trade Collection AMBA message which will be processed by one of the
                                Trade Collection ATSs.
...
try:
    from FC_REQT_PT_ATS_WORKER import FC_REQT_PT_ATS_WORKER as REQT_PT_ATS_WORKER
except ImportError, e:
