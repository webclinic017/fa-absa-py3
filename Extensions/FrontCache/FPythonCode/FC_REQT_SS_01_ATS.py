'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_REQT_SS_01_ATS
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Front Cache Request Type Settlement Trade
                                ATS. This ATS will know how to handel a Settlement TRADE requests and to pass it
                                onto a Settlement Collection ATS. Because Settlement requests are only based on 1
                                settlement, this ATS can be seen as a pass through ATS.
...
try:
    from FC_REQT_SS_ATS_WORKER import FC_REQT_SS_ATS_WORKER as REQT_SS_ATS_WORKER    
except ImportError, e:
