...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_REQT_IT_ATS_WORKER
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module will receive an Instrument Trades Request. It will the send a response
...
----------------------------------------------------------------------------------------------------------'''
class FC_REQT_IT_ATS_WORKER(REQT_ATS_WORKER_BASE.FC_REQT_ATS_WORKER_BASE):
    def __init__(self):
