...
'''----------------------------------------------------------------------------------------------------------
MODULE                  :       FC_REQ_COORD_01_ATS
PROJECT                 :       FX onto Front Arena
PURPOSE                 :       This module is the entry point for the Front Cache Request Event Coordinator ATS.
                                This ATS will subscribe to a REQUEST type messages from the AMB, log them
                                to a database, give the request to the appropriate REQUEST TYPE ATS and send the RESPONSE
...
try:
    from FC_REQ_COORD_ATS_WORKER import FC_REQ_COORD_ATS_WORKER as REQ_COORD_ATS_WORKER
except ImportError, e:
