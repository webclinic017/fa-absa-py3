		...
		<fo:root>
			<fo:layout-master-set>
				...
				<fo:simple-page-master master-name="last_page" page-width="297mm" page-height="210mm" margin-top="5mm" margin-bottom="10mm" margin-left="10mm" margin-right="10mm">
					...
					<fo:region-before region-name="xsl-region-before" extent="45mm"/>
					<fo:region-after region-name="xsl-region-after-last" extent="20mm"/>
				</fo:simple-page-master>
			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="14mm"/><!-- Traded Currency -->
						<fo:table-column column-width="15mm"/><!-- FX Rate -->
						<fo:table-column column-width="15mm"/><!-- Closing Position -->
						<fo:table-column column-width="15mm"/><!-- Closing Price -->
						<fo:table-column column-width="15mm"/><!-- MTM Change (Settlement) -->
						<fo:table-column column-width="15mm"/><!-- MTM Change (Reported) -->
						<fo:table-column column-width="15mm"/><!-- Barclays Principal fee (Settlement) -->
						<fo:table-column column-width="15mm"/><!-- Daily PnL (Settlement) -->
						<fo:table-column column-width="15mm"/><!-- Daily PnL (Reported) -->
						<fo:table-column column-width="15mm"/><!-- Monthly PnL (Settlement) -->
						<fo:table-column column-width="15mm"/><!-- Monthly PnL (Reported) -->
						<fo:table-column column-width="15mm"/><!-- Yearly PnL (Settlement) -->
						<fo:table-column column-width="15mm"/><!-- Yearly PnL (Reported) -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell>
									<fo:block text-align="left" font-weight="bold">FX Rate</fo:block>
								</fo:table-cell>
								<fo:table-cell>
								...
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">MTM Change</fo:block>
									<fo:block text-align="right" font-weight="bold">(Settlement)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">MTM Change</fo:block>
									<fo:block text-align="right" font-weight="bold">(Reported)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Barclays Principal fee</fo:block>
									<fo:block text-align="right" font-weight="bold">(Settlement)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Daily PnL</fo:block>
									<fo:block text-align="right" font-weight="bold">(Settlement)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Daily PnL</fo:block>
								...
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Monthly PnL</fo:block>
									<fo:block text-align="right" font-weight="bold">(Settlement)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Monthly PnL</fo:block>
								...
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Yearly PnL</fo:block>
									<fo:block text-align="right" font-weight="bold">(Settlement)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Yearly PnL</fo:block>
                        ...
                        <xsl:choose>
                            <xsl:when test="count(//Rows/Row/Rows/Row) &gt; 0">
                            <fo:table-body>
                                <xsl:apply-templates/>
                            </fo:table-body>
                            </xsl:when>
