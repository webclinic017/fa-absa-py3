			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="15mm"/><!-- Expiry Date -->
						<fo:table-column column-width="15mm"/><!-- Traded Currency -->
						<fo:table-column column-width="15mm"/><!-- FX Rate -->
						<fo:table-column column-width="15mm"/><!-- Opening Position -->
						<fo:table-column column-width="15mm"/><!-- Opening Price -->
						...
						<fo:table-column column-width="20mm"/><!-- MTM Change (Settlement) -->
						<fo:table-column column-width="20mm"/><!-- MTM Change (Reported) -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell>
									<fo:block text-align="left" font-weight="bold">Expiry</fo:block>
								...
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Opening Position</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Opening Price</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Closing Position</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Closing Price</fo:block>
								</fo:table-cell>
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">Position Change</fo:block>
								</fo:table-cell>
								<fo:table-cell>
