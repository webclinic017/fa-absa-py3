			...
			<fo:page-sequence master-reference="page_sequence">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:table table-layout="fixed" font-size="7pt" border-spacing="2pt" break-after="page">
						...
						<fo:table-column column-width="20mm"/><!-- MTM Change (Reporting) -->
						<fo:table-column column-width="20mm"/><!-- Barclays Principal fee (Settlement) -->
						<fo:table-column column-width="25mm"/><!-- Daily PnL (Settlement) -->
						<fo:table-column column-width="25mm"/><!-- Daily PnL (Reporting) -->
						<fo:table-header>
							<fo:table-row border-top="solid black 1pt" border-bottom="solid black 1pt">
								...
								<fo:table-cell>
									<fo:block text-align="right" font-weight="bold">MTM Change</fo:block>
									<fo:block text-align="right" font-weight="bold">(Reporting)</fo:block>
								</fo:table-cell>
								<fo:table-cell>
