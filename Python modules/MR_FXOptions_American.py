...
CR Number               :[264536, 275268, 714504],[792659 07/10/2011]
...
#    Trade = acm.FTrade[t.trdnbr]
    ...
    if (i.insaddr) not in InsL:
        ...
        SettlementProcFUNC  =       '@optimal exercise settlement THEO'
