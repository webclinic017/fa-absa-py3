...
ael_variables.add('output_fileName', label = 'Output File Name', cls = 'string', default = 'Volcker_MOPL.dat')
...
def file_data(trade, tradeScalars, sdsIdLookup, repday, *rest):
    ...
    if round(marketVal , 2) == 0.00:
        ...
        data = REPORT_ENTRY(
            ...
            INSTRUMENT_DESCRIPTION = trade['Ccy1'] +'/' + trade['Ccy2'],  # replace pipe with slash
            ...
            DELTA_PERCENTAGE = '0.00', 
            IR01 = '0.00', 
            MARKET_VALUE = str(round(marketVal, 2)), 
            SOURCE_SYSTEM = 'ABCAP_MIDAS',
            OPTION_TYPE = '', 
            STRIKE = '', 
            COUPON = '', 
            UNDERLYING_SYMBOL = '', 
