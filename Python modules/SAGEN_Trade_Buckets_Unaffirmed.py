...
#   What
# =============================================================================
    Ops         Letitia Carboni         Dmitry Kovalenko     CHNG0002342336 (2014-10-6)
    Copy of SAGEN_Trade_Buckets to use SAGEN_Trade_Bucket_Unaffirmed_Query
'''
...
ael_gui_parameters = {'windowCaption':'SAGEN Unaffirmed Trade Buckets report'}
parties = acm.FParty.Select('')
default_name = 'SAGEN_Trade_Buckets_Unaffirmed'
...
def ael_main(parameters):
    ...
    query_text = acm.FSQL['SAGEN_Trade_Buckets_Unaffirmed'].Text()
