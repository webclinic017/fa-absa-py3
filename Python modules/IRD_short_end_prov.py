...
lmpc = []
lmpc.append(ael.date('2007-12-06'))
lmpc.append(ael.date('2008-01-31'))
lmpc.append(ael.date('2008-04-10'))
lmpc.append(ael.date('2008-06-12'))
lmpc.append(ael.date('2008-08-14'))
lmpc.append(ael.date('2008-10-09'))
lmpc.append(ael.date('2008-12-11'))
...
#print get_next_mpc(ael.date('2008-10-08'))
...
def mkt_rate_pt(params):    
    ...
    for k in range(1, 10):    
        ins = ael.Instrument['ZAR/FRA/JI/' + str(k) + 'X' + str(k+3) + '/PriceTesting']
        dte = d1.add_months(k).adjust_to_banking_day(ccy)
        rt = ins.used_price()
...
def mkt_rate_USD_pt(params):    
    ...
    for k in range(1, 10):    
        ins = ael.Instrument['USD/FRA/LI/' + str(k) + '-' + str(k+3) ]
        dte = d1.add_months(k).adjust_to_banking_day(ccy)
        rt = ins.used_price()
