...
#------------------------------Get External Files-------------------------    
    ...
    fileJSE = 'Z:/' + date.to_string('%Y-%m-%d') + '/' + date.to_string('%b%Y') + date.to_string('%Y%m%d') + 'BDAExport.csv'
    fileStock = 'Z:/' + date.to_string('%Y-%m-%d') + '/' + 'SAEQ_Stocks_and_Warrants_' + date.to_string('%Y%m%d') + '.csv'
#-------------------------------------------------------------------------
...
#--------------------------Open Output File-------------------------------
    ...
    fileOutput = 'Z:/' + date.to_string('%Y-%m-%d') + '/SAEQ_Stock_Recon_' + date.to_string('%Y%m%d') + '.csv'
