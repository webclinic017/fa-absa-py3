...
import ael
print 40*'-'
aext='arena_ext production '
servusrpwd='-serv 10.3.15.65:9100 -user EXTRACT -passw EX101'
f=file('/services/front/scripts/management/ASQLs/CODE/expq.sh', 'w')
def_file=file('/services/front/scripts/management/ASQLs/PROD_ASQL.def', 'a')
