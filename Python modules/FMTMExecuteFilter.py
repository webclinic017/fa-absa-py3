...
try:
	...
	import SAGEN_CopyMTM_TO_SPOT
    	SAGEN_CopyMTM_TO_SPOT.copy_mtm_to_spot(['ZAR/PIC_BASKET', 'ZAR/OPTI', 'ZAR/OPTI_NEW', 'ZAR/PIC2', 'ZAR/PIC3', 'ZAR/CAD', 'ZAR/CAD2', 'ZAR/ASAB', 'ZAR/KMBB', 'ZAR/CDBA', 'ZAR/CDZ_BASKET', 'ZAR/INVESTEC_BASKET', 'ZAR/CDCH_BASKET'])
...
#############
	    ...
	    if update_vol:
    	    ...
    	    import SAGEN_CopyMTM_TO_SPOT
    	    SAGEN_CopyMTM_TO_SPOT.copy_mtm_to_spot(['ZAR/PIC_BASKET', 'ZAR/OPTI', 'ZAR/OPTI_NEW', 'ZAR/PIC2', 'ZAR/PIC3', 'ZAR/CAD', 'ZAR/CAD2', 'ZAR/ASAB', 'ZAR/KMBB', 'ZAR/CDBA', 'ZAR/CDZ_BASKET', 'ZAR/INVESTEC_BASKET'])
