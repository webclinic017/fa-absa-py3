...
def get_active_advice_business_processes_in_error():
    ...
    asql_query.AddAttrNode('StateChart.Name', 'EQUAL', PreSettlementAdviceGeneral.get_advice_state_chart_name())
    ...
    asql_query.AddAttrNode(event_attribute_name, 'EQUAL', PreSettlementAdviceGeneral.get_advice_event_name())
    ...
    for instrument_type in PreSettlementAdviceGeneral.get_supported_advice_instrument_types():
        instrument_type_node.AddAttrNode(instrument_type_attribute_name, 'EQUAL', instrument_type)
