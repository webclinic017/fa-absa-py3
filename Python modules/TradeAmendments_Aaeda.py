...
def listener(o, e, arg, op):
    ...
    elif op in ('update'): # or (e.record_type == 'Payment' and op in ('insert', 'update')):
                ...
                #try:
                    if  ael.get_old_entity().pp() <> None:
                        if e.pp() <>   ael.get_old_entity().pp():
                            ...
                            if (e.legnbr.insaddr.trades() == None) or (e.legnbr.insaddr.trades().members() == []):
                                prf = ''
                                reltrd = ''
                                stat = ''
                                confoDate = ''
                ...
                #try:
                    if ael.get_old_entity().pp() <> None:
                        if e.pp() <> ael.get_old_entity().pp():
                            ...
                            if (e.insaddr.trades() == None) or (e.insaddr.trades().members() == []):
                                prf = ''
                                reltrd = ''
                                stat = ''
                                confoDate = ''
                ...
                #try:
                    if  ael.get_old_entity().pp() <> None:
                        if e.pp() <> ael.get_old_entity().pp():
                            ...
                            if (e.trades() == None) or (e.trades().members() == []): 
                                prf = ''
                                reltrd = ''
                                stat = ''
                                confoDate = ''
