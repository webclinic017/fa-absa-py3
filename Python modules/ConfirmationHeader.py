...
def FirstPageHeader(canvas, t):
    ...
    canvas.setFont("Helvetica", 10.0)
    canvas.drawString(5.0 * cm, 20.5*cm, 'Absa Bank Limited, Johannesburg')
    ...
    canvas.drawString(5.0 * cm, 23.5*cm, DATE)
    canvas.drawString(5.0 * cm, 23.0*cm, TO)
    canvas.drawString(5.0 * cm, 22.5*cm, ATT)
    canvas.drawString(5.0 * cm, 22.0*cm, TELEPHONE)
    canvas.drawString(5.0 * cm, 21.5*cm, FAXNUMBER)
    canvas.drawString(5.0 * cm, 21.0*cm, EMAIL)
    canvas.drawString(5.0 * cm, 19.5*cm, REFERENCENO)
