...
<query>
[('', '(', 'Portfolio', 'equal to', 'JOB11', ''),
('Or', '', 'Portfolio', 'equal to', 'DERV3', ''),
('Or', '', 'Portfolio', 'equal to', 'NG_Bond_Risk', ''),
...
('And', '', 'Counterparty', 'not equal to', 'PRESCIENT SECURITIES PTY LTD', ''),
...
('And', '', 'Execution time', 'greater than', '01/15/2019 10:00:00 PM', ''),
('And', '', 'Counterparty', 'equal to', 'PRIME SERVICES DESK', '')
]
</query>
</FTradeFilter>
